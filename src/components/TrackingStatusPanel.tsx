  ...
  return (
    ...
    >
      ...
      <div className="px-5 md:px-8 pb-8 overflow-y-auto">
        ...
        {/* Route card */}
        <div className="bg-[#FFFFFF] border border-[#E5E7EB] shadow-sm text-[#1A0B00] rounded-2xl p-5 mb-4 relative overflow-hidden">
        ...
        <div className="grid grid-cols-2 gap-3 mb-4">
          <div className="bg-[#FFFFFF] border border-zinc-100 rounded-2xl p-4 flex flex-col gap-1">
