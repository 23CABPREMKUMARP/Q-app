    ...
    >
      ...
      <div className="absolute inset-0 z-10 pointer-events-none flex items-center justify-center">
        ...
        <div className="relative w-[280px] h-[280px] shadow-[0_0_0_9999px_rgba(0,0,0,0.65)] rounded-[32px]">
          {/* Saffron Corners */}
          <div className="absolute top-0 left-0 w-12 h-12 border-t-[6px] border-l-[6px] border-[#A4E5E0] rounded-tl-[32px]" />
          <div className="absolute top-0 right-0 w-12 h-12 border-t-[6px] border-r-[6px] border-[#A4E5E0] rounded-tr-[32px]" />
          <div className="absolute bottom-0 left-0 w-12 h-12 border-b-[6px] border-l-[6px] border-[#A4E5E0] rounded-bl-[32px]" />
          <div className="absolute bottom-0 right-0 w-12 h-12 border-b-[6px] border-r-[6px] border-[#A4E5E0] rounded-br-[32px]" />
          
          {/* Animated Scanning Line */}
          <div className="absolute top-0 left-0 w-full h-[2px] bg-[#A4E5E0] shadow-[0_0_20px_rgba(255,153,51,0.8)] animate-[scan_3s_ease-in-out_infinite]" />
        </div>
      </div>
      ...
      {error && (
        <div className="absolute z-20 flex flex-col items-center justify-center bg-black/80 backdrop-blur-md rounded-2xl p-6 text-center gap-4 m-8">
          ...
          <button onClick={onClose} className="px-6 py-2 bg-[#A4E5E0] text-white rounded-full font-black text-xs uppercase tracking-widest">Close</button>
        </div>
      )}
      ...
      <div className="absolute top-12 left-6 z-20 flex flex-col gap-4 items-start">
        <div className="flex items-center gap-2 bg-black/40 backdrop-blur-md px-3 py-2 rounded-full border border-white/10">
          ...
          <div className="flex flex-col">
            <span className="text-[10px] font-black text-white leading-none tracking-tight">DIGI <span className="text-[#A4E5E0]">BUS</span></span>
          ...
          >
            <div className="bg-black/60 backdrop-blur-md p-4 rounded-2xl border border-white/10">
              <input 
                ...
                className="w-full bg-white/10 border border-white/20 rounded-xl px-4 py-3 text-white font-black text-sm uppercase tracking-widest placeholder:text-white/40 focus:outline-none focus:border-[#A4E5E0] transition-colors"
                onKeyDown={(e) => {
                  if (e.key === 'Enter') {
