    ...
    <div className="relative w-full h-full min-h-[100dvh] bg-[#FFF5E6] flex flex-col items-center justify-center overflow-hidden">
        ...
        <svg width="100%" height="100%" xmlns="http://www.w3.org/2000/svg">
          <defs>
            <pattern id="kolam-pattern" x="0" y="0" width="120" height="120" patternUnits="userSpaceOnUse">
              ...
              <path d="M 60 10 C 80 10 110 40 110 60 C 110 80 80 110 60 110 C 40 110 10 80 10 60 C 10 40 40 10 60 10 Z" fill="none" stroke="#1A0B00" strokeWidth="1" strokeDasharray="4 4" />
              <path d="M 60 25 L 95 60 L 60 95 L 25 60 Z" fill="none" stroke="#1A0B00" strokeWidth="0.5" />
              <circle cx="60" cy="60" r="15" fill="none" stroke="#1A0B00" strokeWidth="1" />
              {/* Central dot */}
              <circle cx="60" cy="60" r="2" fill="#1A0B00" />
              {/* Peripheral dots */}
              <circle cx="60" cy="25" r="2" fill="#1A0B00" />
              <circle cx="60" cy="95" r="2" fill="#1A0B00" />
              <circle cx="25" cy="60" r="2" fill="#1A0B00" />
              <circle cx="95" cy="60" r="2" fill="#1A0B00" />
            </pattern>
          </defs>
      ...
      <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
        <motion.div
          ...
          className="absolute top-1/4 left-1/4 w-32 h-32 bg-[#FF6D00]/5 rounded-full blur-3xl"
        />
        <motion.div
          animate={{ y: [0, 20, 0], opacity: [0.2, 0.4, 0.2] }}
          transition={{ duration: 7, repeat: Infinity, ease: "easeInOut" }}
          className="absolute bottom-1/3 right-1/4 w-48 h-48 bg-[#1A0B00]/5 rounded-full blur-3xl"
        />
        ...
        <svg className="absolute left-1/2 top-1/4 -translate-x-1/2 w-[2px] h-1/2 opacity-20" preserveAspectRatio="none">
           <line x1="1" y1="0" x2="1" y2="100%" stroke="#1A0B00" strokeWidth="2" strokeDasharray="6 6" />
        </svg>
      </div>
      ...
      <div className="absolute bottom-0 left-0 w-full z-10 opacity-[0.07] pointer-events-none flex justify-center">
        <svg viewBox="0 0 1440 250" className="w-full h-auto max-h-[250px] object-cover" preserveAspectRatio="xMidYMax slice" xmlns="http://www.w3.org/2000/svg">
          {/* Main Gopuram Base */}
          <path d="M 0 250 L 1440 250 L 1440 220 L 1200 220 L 1150 170 L 1100 220 L 850 220 L 780 80 L 750 80 L 720 20 L 690 80 L 660 80 L 590 220 L 340 220 L 290 170 L 240 220 L 0 220 Z" fill="#1A0B00" />
          {/* Main Gopuram Spire (Kalasam) */}
          <rect x="715" y="5" width="10" height="15" rx="3" fill="#1A0B00" />
          <path d="M 720 0 L 720 20" stroke="#1A0B00" strokeWidth="2" />
      ...
      <div className="relative z-20 flex flex-col items-center max-w-md px-6 text-center mt-[-5vh]">
        ...
        <div className="mb-6 relative w-20 h-20 flex items-center justify-center">
          <svg viewBox="0 0 24 24" fill="none" stroke="#1A0B00" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-16 h-16 opacity-80">
            {/* Dot */}
            <circle cx="12" cy="20" r="1" fill="#1A0B00" />
            {/* Inner arc */}
            <motion.path 
        ...
        >
          ...
          <svg viewBox="0 0 200 220" width="160" height="176" xmlns="http://www.w3.org/2000/svg">
            {/* Bus Body Base */}
            <rect x="25" y="20" width="150" height="170" rx="28" fill="#FF6D00" />
            ...
            <rect x="60" y="135" width="80" height="25" rx="8" fill="#1A0B00" />
            ...
            <rect x="147" y="156" width="18" height="4" rx="2" fill="#FF6D00" />

            {/* Bumper */}
            <rect x="25" y="170" width="150" height="12" rx="4" fill="#334155" />

            {/* Side Mirrors (Modern sleek style) */}
            <path d="M 25 70 L 12 70 C 8 70 6 72 6 76 L 6 95 C 6 100 8 102 12 102 L 18 102 C 22 102 25 100 25 96 Z" fill="#1A0B00" />
            <path d="M 175 70 L 188 70 C 192 70 194 72 194 76 L 194 95 C 194 100 192 102 188 102 L 182 102 C 178 102 175 100 175 96 Z" fill="#1A0B00" />

            {/* Wheels */}
            <rect x="35" y="180" width="28" height="30" rx="10" fill="#1A0B00" />
            <rect x="137" y="180" width="28" height="30" rx="10" fill="#1A0B00" />
            {/* Hubcaps */}
        ...
        {/* Text Area */}
        <motion.h1 
          className="text-2xl md:text-3xl font-black text-[#1A0B00] tracking-tight mb-3"
