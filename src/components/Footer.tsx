...
export const Footer = React.memo(function Footer() {
  ...
  return (
    <footer className="bg-[#8B1E2E] text-white pt-24 pb-12 border-t border-white/20">
      <div className="container mx-auto px-6 max-w-7xl">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-16">
            ...
            <Link href="/" className="flex flex-col gap-2">
              ...
              <div className="flex flex-col">
                <span className="text-2xl font-bold tracking-tight leading-none">
                  <span className="text-black">JEFF</span><span className="text-white">BEN</span>
                </span>
            ...
            <div className="flex items-center gap-4">
              {[
                ...
                <motion.a
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="w-12 h-12 rounded-2xl bg-white/5 border border-white/20 flex items-center justify-center text-white hover:bg-white/10 transition-all"
                >
                  {social.icon}
                </motion.a>
              ))}
          ...
          <div className="space-y-8">
            <h4 className="text-xs font-bold uppercase tracking-widest text-white/80">Platform</h4>
            <nav className="flex flex-col gap-4">
              {[
                ...
                <Link 
                  ...
                  className="text-white/90 hover:text-black transition-all flex items-center justify-between group"
                >
          ...
          {/* Contact Info */}
          <div className="space-y-8">
            <h4 className="text-xs font-bold uppercase tracking-widest text-white/80">Intelligence Hub</h4>
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-white/90 text-sm font-bold">Tamil Nadu, India</span>
                </div>
              </div>
              <div className="flex items-start gap-4">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-white/90 text-sm font-bold underline underline-offset-4">jeffbenofficial1@gmail.com</span>
                </div>
              </div>
              <div className="flex items-start gap-4">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-white/90 text-sm font-bold">Industrial Telemetry Div.</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="mt-24 pt-8 border-t border-white/20 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-8">
            <Link href="/privacy" className="text-white hover:text-black text-xs font-bold uppercase tracking-[0.2em] transition-all drop-shadow-sm">Privacy Policy</Link>
            <Link href="/terms" className="text-white hover:text-black text-xs font-bold uppercase tracking-[0.2em] transition-all drop-shadow-sm">Terms of Service</Link>
          </div>
        </div>
      </div>
    </footer>
