...
export default function Splash() {
  return (
    <div className="fixed inset-0 z-[200] bg-[#FF5F1F] flex flex-col items-center justify-center p-6">
      <motion.div
      ...
      >
        ...
        <div className="w-48 h-1 bg-black/10 rounded-full overflow-hidden relative">
          <motion.div
            ...
            className="absolute top-0 bottom-0 w-1/2 bg-[#ffffff] border border-[#E5E7EB] text-[#111827] rounded-full"
          />
        </div>
