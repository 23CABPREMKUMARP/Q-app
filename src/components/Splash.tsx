...
export default function Splash() {
  return (
    <div className="fixed inset-0 z-[200] bg-[#FF6D00] flex flex-col items-center justify-center">
      {/* Desktop Loading Video */}
      <div className="hidden md:flex absolute inset-0 w-full h-full items-center justify-center bg-[#FF6D00]">
        <video 
          src="/videos/desktop-loading.mp4"
          autoPlay
          muted
          loop
          playsInline
      ...
      <div className="flex md:hidden w-full h-full flex-col items-center justify-center p-6">
        <motion.div
