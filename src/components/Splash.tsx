      ...
      >
        ...
        <div className="absolute top-12 inset-x-0 flex justify-center z-10 md:hidden pointer-events-none">
          <motion.div 
            ...
            className="px-6 py-2 bg-black/30 backdrop-blur-md rounded-full shadow-lg border border-white/10"
          >
        ...
        {/* Mobile Bottom Text */}
        <div className="absolute bottom-12 inset-x-0 flex justify-center z-10 md:hidden px-6 text-center pointer-events-none">
          <motion.p 
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 1, duration: 0.8 }}
            className="text-[#FFFFFF] font-bold text-base leading-relaxed drop-shadow-md bg-black/30 backdrop-blur-md p-5 rounded-3xl shadow-lg border border-white/10"
          >
