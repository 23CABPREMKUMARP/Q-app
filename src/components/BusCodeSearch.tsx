      ...
      >
        <div className="p-6 md:p-8">
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="w-12 h-12 bg-[#FFFFFF] border border-zinc-100 shadow-sm text-[#1A0B00] rounded-2xl flex items-center justify-center shadow-lg">
          ...
          <div className="mt-8 pt-6 border-t border-zinc-50 flex items-center justify-between">
            ...
            >
              <div className="w-10 h-10 bg-[#FFFFFF] rounded-xl flex items-center justify-center group-hover:bg-zinc-100 transition-all">
                <QrCode size={20} />
              </div>
