...
export default function MobileDashboard() {
  ...
  return (
    <AnimatePresence mode="wait">
      ...
      >
        {/* PhonePe Header */}
        <div className="bg-[#FFD700] px-4 pt-12 pb-4 text-[#111827] sticky top-0 z-[100] shadow-md rounded-b-2xl">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-3">
              <div className="bg-[#F8FAFC]/20 p-1 rounded-full">
                <UserButton
                  appearance={{
                    elements: {
          ...
          <div className="relative mt-2">
            ...
            <input 
              type="text" 
              className="w-full bg-[#F8FAFC] text-slate-900 rounded-xl pl-11 pr-4 py-3 text-sm shadow-sm outline-none placeholder:text-slate-500"
        ...
        <div className="px-4 mt-4 space-y-4 max-w-md mx-auto">
          ...
          {liveTripTrack && (
            ...
            >
              ...
              <div className="relative z-10 flex items-center justify-between">
                ...
                <div className="w-12 h-12 bg-[#FFD700] text-[#111827] rounded-2xl flex items-center justify-center shadow-lg group-hover:rotate-12 transition-transform">
          ...
          {notifications.length > 0 && (
            <motion.div
              ...
              className="bg-[#F8FAFC] rounded-3xl p-5 shadow-sm border border-slate-100/50 space-y-4 text-left overflow-hidden relative"
            >
              ...
              <div className="space-y-2.5 max-h-[220px] overflow-y-auto pr-1">
                {notifications.map((notif: any) => (
                  <div
                    key={notif._id}
                    className="p-3.5 bg-[#F8FAFC] hover:bg-slate-100/70 transition-all rounded-2xl border border-slate-100 flex gap-3 relative overflow-hidden"
                  >
                    ...
                    <div className="flex-1 pl-1 space-y-1">
                      ...
                      <p className="text-[11px] text-[#6B7280] leading-relaxed font-medium">{notif.message}</p>
                    </div>
                  </div>
                ))}
              </div>
          ...
          <div className="bg-[#F8FAFC] rounded-2xl p-4 shadow-sm">
          ...
          <div className="bg-[#F8FAFC] rounded-2xl p-4 shadow-sm">
            ...
            <div className="flex gap-4">
              <div className="flex-1 bg-[#F8FAFC] rounded-xl p-3 border border-slate-100 flex flex-col justify-center">
              ...
              <Link href="/get-ticket" className="flex-1 bg-[#F8FAFC] rounded-xl p-3 border border-slate-100 flex flex-col justify-center relative overflow-hidden">
          ...
          <div className="text-center pt-4 pb-6">
            <p className="text-[10px] font-medium text-[#6B7280] flex items-center justify-center gap-1">
          ...
          {showNotificationsModal && (
            ...
            >
              <motion.div
                ...
                className="w-full max-w-md bg-[#F8FAFC] rounded-t-[32px] p-6 shadow-2xl space-y-6 max-h-[85vh] overflow-y-auto pb-10"
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                ...
                <div className="space-y-3 pt-2">
                  {notifications.length === 0 ? (
                    <div className="text-center py-10 space-y-2">
                      <p className="text-sm font-bold text-[#6B7280]">No Notifications Yet</p>
                      <p className="text-xs text-[#6B7280]">We'll alert you here when your booked bus trip starts or the driver sends updates.</p>
                    </div>
                  ) : (
                    notifications.map((notif: any) => (
                      <div
                        key={notif._id}
                        className="p-4 bg-[#F8FAFC] rounded-2xl border border-slate-100 flex gap-3 relative overflow-hidden text-left"
                      >
          ...
          {showBusCodeModal && (
            ...
            >
              <motion.div
                ...
                exit={{ y: "100%" }}
                transition={{ type: "spring", damping: 25, stiffness: 200 }}
                className="w-full max-w-md bg-[#F8FAFC] rounded-t-[32px] p-6 shadow-2xl space-y-6 max-h-[85vh] overflow-y-auto pb-10 relative text-left"
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 bg-[#FFD700]/15 rounded-xl flex items-center justify-center">
          ...
          {showPassModal && (
            ...
            >
              <motion.div
                ...
                exit={{ y: "100%" }}
                transition={{ type: "spring", damping: 25, stiffness: 200 }}
                className="w-full max-w-md bg-[#F8FAFC] border border-[#E5E7EB] shadow-sm text-[#111827] rounded-t-[32px] p-6 shadow-2xl space-y-6 max-h-[85vh] overflow-y-auto pb-10 relative text-left border-t border-amber-900/30"
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                  ...
                  <button
                    ...
                    className="p-2 bg-[#F8FAFC] border border-[#E5E7EB] text-[#111827] hover:bg-slate-700 text-[#6B7280] rounded-full font-bold text-xs cursor-pointer border-none outline-none focus:outline-none"
                  >
                    Close
                  </button>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="bg-gradient-to-br from-slate-200 to-slate-400 p-[1px] rounded-2xl">
                      <div className="bg-[#F8FAFC] border border-[#E5E7EB] shadow-sm text-[#111827] rounded-2xl p-4 h-full flex items-center gap-4">
                        ...
                        <div className="text-right">
                          <span className="text-[10px] font-black bg-[#F8FAFC] border border-[#E5E7EB] text-[#111827] text-[#6B7280] px-2 py-1 rounded-md uppercase">Soon</span>
                        </div>
                      </div>
                    </div>
              ...
              >
                ...
                <div className="space-y-4">
                  <div className="space-y-1">
                    <label className="text-[10px] font-black text-[#6B7280] uppercase tracking-widest block">Address / Neighborhood</label>
                    <input 
                      type="text"
                      value={addressInput}
                      onChange={(e) => setAddressInput(e.target.value)}
                      placeholder="e.g. Gandhipuram, Coimbatore"
                      className="w-full bg-[#F8FAFC] border-2 border-slate-100 focus:border-slate-900 rounded-xl p-3.5 text-xs font-bold text-slate-950 placeholder:text-slate-300 outline-none transition-all"
                    />
                  </div>

                  {/* Preset Locations */}
                  <div className="space-y-2">
                    <span className="text-[8px] font-black text-[#6B7280] uppercase tracking-widest block">Popular Neighborhoods</span>
                    <div className="flex flex-wrap gap-2">
                      {["Gandhipuram, CBE", "Ukkadam, TN", "Saravanampatti", "Annur Hub", "Mettupalayam"].map((preset) => (
                        <button
                          ...
                          className="px-3 py-1.5 bg-[#F8FAFC] hover:bg-slate-100 border border-slate-100 rounded-lg text-[10px] font-bold text-[#6B7280] transition-all active:scale-95"
                        >
                          {preset}
                        </button>
                      ))}
                  ...
                  <button
                    ...
                    className="w-full h-12 bg-[#F8FAFC] border border-[#E5E7EB] shadow-sm text-[#111827] hover:bg-[#FFD700] text-[#111827] rounded-xl font-bold uppercase tracking-widest text-[10px] flex items-center justify-center gap-2 transition-all active:scale-95 shadow-md"
                  >
          ...
          {showMembershipModal && (
            ...
            >
              <motion.div
                ...
                className="w-full max-w-md bg-[#F8FAFC] rounded-[32px] p-6 shadow-2xl relative overflow-hidden"
              >
                ...
                <div className="space-y-3 relative z-10">
                  ...
                  <div className="p-4 rounded-2xl border border-slate-100 bg-gradient-to-r from-slate-100 to-slate-50 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h4 className="font-black text-[#6B7280]">Platinum Pass</h4>
                        <p className="text-[9px] font-bold text-[#6B7280] uppercase tracking-widest">Unlimited Travel</p>
                      </div>
                    </div>
                    <span className="text-[9px] font-black bg-slate-200 text-[#6B7280] px-2 py-1 rounded-full uppercase tracking-wider">Coming Soon</span>
                  </div>
