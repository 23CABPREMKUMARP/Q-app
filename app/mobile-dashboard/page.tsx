      ...
      >
        ...
        <div className="bg-[#FF6D00] px-4 pt-12 pb-4 text-[#1A0B00] sticky top-0 z-[100] shadow-md rounded-b-2xl">
          ...
          <div className="relative mt-2">
            ...
            <input 
              type="text" 
              className="w-full bg-[#FFFFFF] text-[#1A0B00] rounded-xl pl-11 pr-4 py-3 text-sm shadow-sm outline-none placeholder:text-slate-500"
          ...
          <div className="bg-[#FFFFFF] border border-[#E5E7EB] shadow-sm rounded-2xl overflow-hidden shadow-md relative group">
            ...
            <div className="p-5 text-[#1A0B00] relative z-10 flex items-center justify-between">
              <div className="w-2/3 pr-2">
                ...
                <h3 className="text-xl font-black tracking-tight mb-1 text-[#1A0B00]">Town Bus Booking</h3>
              ...
              <div className="absolute right-0 bottom-0 top-0 w-1/3 flex items-center justify-end pr-4 opacity-90 overflow-hidden">
                ...
                <div className="bg-[#FFFFFF] w-16 h-16 rounded-full flex items-center justify-center shadow-xl z-10 border border-gray-100">
          ...
          {showPassModal && (
            ...
            >
              <motion.div
                ...
                exit={{ y: "100%" }}
                transition={{ type: "spring", damping: 25, stiffness: 200 }}
                className="w-full max-w-md bg-[#FFFFFF] border border-[#E5E7EB] shadow-sm text-[#1A0B00] rounded-t-[32px] p-6 shadow-2xl space-y-6 max-h-[85vh] overflow-y-auto pb-10 relative text-left border-t border-amber-900/30"
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                  ...
                  <button
                    ...
                    className="p-2 bg-[#FFFFFF] border border-[#E5E7EB] text-[#1A0B00] hover:bg-slate-700 text-[#6B7280] rounded-full font-bold text-xs cursor-pointer border-none outline-none focus:outline-none"
                  >
                    Close
                  </button>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="bg-gradient-to-br from-slate-200 to-slate-400 p-[1px] rounded-2xl">
                      <div className="bg-[#FFFFFF] border border-[#E5E7EB] shadow-sm text-[#1A0B00] rounded-2xl p-4 h-full flex items-center gap-4">
                        ...
                        <div className="text-right">
                          <span className="text-[10px] font-black bg-[#FFFFFF] border border-[#E5E7EB] text-[#1A0B00] text-[#6B7280] px-2 py-1 rounded-md uppercase">Soon</span>
                        </div>
                      </div>
                    </div>
                ...
                <div className="space-y-4">
                  <div className="space-y-1">
                    ...
                    <input 
                      ...
                      className="w-full bg-[#FFFFFF] border-2 border-slate-100 focus:border-slate-900 rounded-xl p-3.5 text-xs font-bold text-[#1A0B00] placeholder:text-slate-300 outline-none transition-all"
                    />
                  </div>
                  ...
                  <button
                    ...
                    className="w-full h-12 bg-[#FFFFFF] border border-[#E5E7EB] shadow-sm text-[#1A0B00] hover:bg-[#FF6D00] text-[#1A0B00] rounded-xl font-bold uppercase tracking-widest text-[10px] flex items-center justify-center gap-2 transition-all active:scale-95 shadow-md"
                  >
