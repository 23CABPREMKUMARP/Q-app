...
export default function BusCodeDetailsPage() {
  ...
  return (
    <div className="min-h-screen bg-[#FFFFFF] font-sans pb-24">
      {/* Header */}
      ...
      <div className="px-6 -mt-16 relative z-20 max-w-md mx-auto">
        {error ? (
          <div className="bg-[#FFFFFF] p-8 rounded-3xl shadow-xl text-center space-y-4">
            ...
            <button onClick={() => router.push('/')} className="mt-4 px-6 py-3 bg-[#FFFFFF] border border-[#E5E7EB] shadow-sm text-[#1A0B00] text-[#1A0B00] rounded-xl font-black uppercase text-xs tracking-widest w-full">Back to Home</button>
          </div>
        ) : (
          <motion.div 
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-4">
              <Link 
                ...
                className="bg-[#FFFFFF] border border-[#E5E7EB] shadow-sm text-[#1A0B00] text-[#1A0B00] p-5 rounded-2xl flex flex-col items-center justify-center gap-2 hover:bg-slate-800 active:scale-95 transition-all shadow-lg"
              >
                <div className="w-10 h-10 rounded-full bg-[#FFFFFF] border border-[#E5E7EB] text-[#1A0B00] flex items-center justify-center">
              ...
              <Link 
                ...
                className="bg-[#FFFFFF] border border-[#E5E7EB] text-[#1A0B00] p-5 rounded-2xl flex flex-col items-center justify-center gap-2 hover:bg-[#FFFFFF] active:scale-95 transition-all shadow-sm"
              >
