...
export default function TicketCountSelectionPage() {
    ...
    try {
      ...
      if (data.success && data.orderId) {
        const options = {
          ...
          redirect: typeof window !== 'undefined' && !!(window as any).Capacitor ? true : false,
  ...
  return (
    <SecureView>
      <div className="min-h-screen bg-[#FFFFFF] font-sans text-[#1A0B00] pb-[320px]">
        {/* Header */}
      ...
      <div className="px-6 mt-12">
        ...
        <div className="bg-[#FFFFFF] border border-[#E5E7EB] shadow-sm text-[#1A0B00] rounded-[32px] p-6 flex items-center justify-between relative overflow-hidden group mb-8 shadow-lg shadow-black/10">
        ...
        <AnimatePresence mode="wait">
              ...
              <div className="bg-[#FFFFFF] border border-zinc-200 rounded-3xl p-8 shadow-sm relative overflow-hidden">
                ...
                <div className="mt-8 pt-4">
                  {passengers.map((passenger, index) => (
                    <div key={index} className="mb-6 bg-[#FFFFFF] border border-zinc-200 rounded-2xl p-5 relative">
                      <div className="absolute -top-3 left-4 bg-[#FFFFFF] px-2 py-0.5 text-[10px] font-black text-[#FF6D00] uppercase tracking-widest border border-zinc-200 rounded-full shadow-sm flex items-center gap-2">
                        Journey {index + 1}
                        {passengers.length > 1 && (
                          <button onClick={() => {
                      ...
                      <div className="grid grid-cols-2 gap-4 mt-2">
                        ...
                        <div className="mb-4">
                          ...
                          <select 
                            ...
                            className="w-full h-12 bg-[#FFFFFF] border border-zinc-200 rounded-xl px-4 font-bold text-sm text-[#1A0B00] outline-none focus:border-[#FF6D00] transition-all cursor-pointer"
                          >
          ...
          {step === 3 && (
            <motion.div 
              ...
              className="space-y-8"
            >
              <div className="bg-[#FFFFFF] rounded-[40px] p-8 text-[#1A0B00] space-y-6 relative overflow-hidden group border border-zinc-200 shadow-sm">
      ...
      Tap to View <ChevronRight size={12} className="text-[#1A0B00]/50" />
              ...
              >
                 ...
                 <button 
                   ...
                   className="col-span-1 h-16 bg-[#FFFFFF] text-zinc-800 rounded-[24px] font-black uppercase tracking-widest text-[9px] hover:bg-[#FFFFFF] transition-all flex items-center justify-center gap-2 active:scale-95 border border-zinc-200"
                 >
                   My Bookings
                 </button>
                 ...
                 <button 
                   onClick={() => router.push('/')}
                   className="col-span-1 h-16 bg-[#FFFFFF] border border-[#E5E7EB] text-[#1A0B00] text-[#1A0B00] rounded-[24px] font-black uppercase tracking-widest text-[9px] hover:bg-slate-700 transition-all flex items-center justify-center gap-2 active:scale-95"
                 >
                   Home
                 </button>
              </motion.div>
          ...
          >
            ...
            <div className="w-full max-w-4xl flex justify-end mb-4 relative z-10">
              <button 
                ...
                className="bg-[#FFFFFF]/20 hover:bg-[#FFFFFF]/40 text-[#1A0B00] rounded-full p-2 backdrop-blur-md transition-colors"
              >
                <X size={24} />
              </button>
            </div>
