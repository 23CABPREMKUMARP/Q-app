...
export default function AboutPage() {
  ...
  return (
    <motion.main 
      ...
      className="min-h-screen bg-[#FFF5E6] text-[#1A0B00] font-sans pb-28 pt-20 overflow-x-hidden safe-bottom"
    >
      {/* Premium Header */}
      <div className="bg-[#FFF5E6] border-b border-slate-100 py-6 px-6 sticky top-0 z-40 shadow-sm flex items-center gap-3">
        ...
        <div>
          <h1 className="text-xl font-bold tracking-tight text-[#1A0B00]">About JeffBen</h1>
          <p className="text-[10px] font-bold text-[#6B7280] uppercase tracking-wider">Transit Intelligence & Operations</p>
        </div>
      </div>

      <div className="px-5 space-y-6 mt-6 max-w-md mx-auto">
        {/* Core Profile Card */}
        <div className="bg-gradient-to-br from-zinc-950 to-zinc-900 rounded-[32px] p-6 text-[#1A0B00] shadow-xl relative overflow-hidden">
          <div className="absolute -right-10 -top-10 w-40 h-40 bg-[#FF6D00]/15 rounded-full blur-3xl" />
          <div className="relative z-10 space-y-4">
            <div className="flex items-center gap-4">
              <div className="w-14 h-14 bg-[#FFF5E6] border border-[#E5E7EB] text-[#1A0B00] rounded-2xl flex items-center justify-center border border-[#E5E7EB]">
                <Image src="/hero-logo.png" alt="JeffBen" width={36} height={36} className="object-contain" />
              </div>
              <div>
                <h2 className="text-xl font-bold tracking-tight text-[#1A0B00]">JeffBen Systems</h2>
            ...
            <div className="grid grid-cols-2 gap-3 pt-3 border-t border-[#FFF5E6]/5 text-center">
              <div className="bg-[#FFF5E6] border border-[#E5E7EB] shadow-sm text-[#1A0B00] rounded-2xl p-3">
        ...
        <div className="bg-[#FFF5E6] rounded-3xl p-6 border border-slate-100 shadow-sm space-y-4">
          <h3 className="text-sm font-bold text-[#6B7280] uppercase tracking-wider mb-2">Corporate Overview</h3>
        ...
        <div className="bg-[#FFF5E6] rounded-3xl p-6 border border-slate-100 shadow-sm overflow-hidden flex flex-col items-center">
          <h3 className="text-sm font-bold text-[#6B7280] uppercase tracking-wider mb-4 w-full text-left">Global Transit Footprint</h3>
          <div className="relative w-full h-[220px] bg-[#FFF5E6] rounded-2xl flex items-center justify-center overflow-hidden border border-slate-100">
          ...
          <span className="text-[9px] font-bold text-[#6B7280] uppercase tracking-widest mt-4">Smart City Telemetry Architecture</span>
        </div>
        ...
        <div className="bg-orange-50/50 rounded-3xl p-6 border border-orange-100 shadow-inner text-center space-y-3">
          ...
          <h3 className="text-base font-bold text-[#1A0B00]">Our Vision</h3>
          <p className="text-xs text-[#6B7280] italic leading-relaxed font-medium">
        ...
        {/* Founder Spotlights */}
        <div className="bg-[#FFF5E6] rounded-3xl p-6 border border-slate-100 shadow-sm space-y-5">
          <h3 className="text-sm font-bold text-[#6B7280] uppercase tracking-wider">Executive Leadership</h3>
          <div className="flex items-center gap-4">

            <div>
              <h4 className="text-sm font-bold text-[#1A0B00]">JeffBen</h4>
              <p className="text-[10px] font-semibold text-[#6B7280] uppercase tracking-wider">Founder & Chief Executive Officer</p>
              <div className="flex gap-2 mt-2">
                <a href="https://youtube.com/@jeffbenofficial" target="_blank" rel="noopener noreferrer" className="p-1.5 bg-[#FFF5E6] hover:bg-slate-100 border border-slate-100 rounded-lg text-[#6B7280] transition-all">
                  <Youtube size={14} />
                </a>
                <a href="mailto:jeffbenofficial1@gmail.com" className="p-1.5 bg-[#FFF5E6] hover:bg-slate-100 border border-slate-100 rounded-lg text-[#6B7280] transition-all">
                  <Mail size={14} />
                </a>
              </div>
            </div>
          </div>
          <p className="text-xs text-[#6B7280] leading-relaxed font-medium pt-2 border-t border-slate-50">
        ...
        <div className="space-y-3">
          <h3 className="text-sm font-bold text-[#6B7280] uppercase tracking-wider pl-2">Solutions Portfolio</h3>
          ...
          <div className="grid grid-cols-1 gap-3">
            {[
              ...
              <div key={idx} className="bg-[#FFF5E6] rounded-2xl p-5 border border-slate-100 shadow-sm flex items-start gap-4">
                ...
                <div>
                  <h4 className="text-xs font-bold text-[#1A0B00] uppercase tracking-tight">{sol.title}</h4>
        ...
        <div className="bg-[#FFF5E6] rounded-3xl p-6 border border-slate-100 shadow-sm space-y-4">
          <h3 className="text-sm font-bold text-[#6B7280] uppercase tracking-wider">The JeffBen Advantage</h3>
          <div className="grid grid-cols-1 gap-3">
            {[
              ...
              <div key={idx} className="flex items-center gap-3">
                <CheckCircle2 size={16} className="text-[#FF6D00] shrink-0" />
        ...
        {/* Technology Overview */}
        <div className="bg-[#FFF5E6] rounded-3xl p-6 border border-slate-100 shadow-sm space-y-4">
          <h3 className="text-sm font-bold text-[#6B7280] uppercase tracking-wider">Technology Stack Matrix</h3>
          <div className="flex flex-wrap gap-2">
            {[
              "Web & Mobile Apps", "GPS-based telemetry", "Cloud Data Systems", 
              "Secure QR Cryptography", "Real-Time Dispatching Engines"
            ].map((tech, idx) => (
              <span key={idx} className="px-3 py-1.5 bg-[#FFF5E6] border border-slate-100 rounded-full text-[9px] font-bold text-[#6B7280] uppercase tracking-wide">
                {tech}
              </span>
            ))}
          </div>
        ...
        <div className="bg-[#FFF5E6] rounded-3xl p-6 border border-slate-100 shadow-sm text-center space-y-4">
          <h3 className="text-xs font-bold text-[#6B7280] uppercase tracking-wider">Strategic Partnerships</h3>
          ...
          <div className="flex items-center justify-center gap-3">
            <Link href="mailto:jeffbenofficial1@gmail.com" className="px-6 py-3 bg-[#FFF5E6] border border-[#E5E7EB] shadow-sm text-[#1A0B00] text-[#1A0B00] rounded-xl text-[10px] font-bold uppercase tracking-wider shadow-md hover:bg-orange-500 transition-all flex items-center gap-2">
              <Mail size={12} /> Contact Us
            </Link>
            <Link href="/get-ticket" className="px-6 py-3 bg-orange-500 text-[#1A0B00] rounded-xl text-[10px] font-bold uppercase tracking-wider shadow-md hover:bg-[#1A0B00] transition-all flex items-center gap-2">
              <Ticket size={12} /> Get a Pass
            </Link>
          </div>
          <p className="text-[8px] font-bold text-[#6B7280] uppercase tracking-widest pt-2 border-t border-slate-50">Verification Matrix v2.3.6 • JEFFBEN Systems</p>
        </div>
      </div>
    </motion.main>
  );
