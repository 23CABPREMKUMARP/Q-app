      ...
      <div className="max-w-xl md:max-w-4xl mx-auto px-5 pt-8 space-y-6">
        ...
        <div className="text-center space-y-2">
          ...
          <motion.p 
            ...
            className="text-[#6B7280] text-xs font-semibold max-w-xs mx-auto leading-relaxed"
          >
          ...
          >
            <div className="flex items-center gap-2">
              <div className="relative flex-1">
                ...
                <input 
                  ...
                  className="w-full bg-[#FFFFFF] border border-[#E5E7EB] rounded-lg py-2 pl-9 pr-3 text-sm focus:ring-2 focus:ring-[#FF6D00]/20 focus:border-[#FF6D00] outline-none"
                />
              </div>
            </div>
            <div className="flex gap-2">
              <button 
                ...
                className={`px-3 py-1.5 rounded-full text-xs font-bold border transition-colors ${statusFilter === 'ALL' ? 'bg-[#FFFFFF] border border-[#E5E7EB] text-[#1A0B00] text-[#1A0B00] border-[#E5E7EB]' : 'bg-[#FFFFFF] text-[#6B7280] border-[#E5E7EB]'}`}
              >
                All Passes
              </button>
              <button 
                onClick={() => setStatusFilter('ACTIVE')}
                className={`px-3 py-1.5 rounded-full text-xs font-bold border transition-colors ${statusFilter === 'ACTIVE' ? 'bg-green-600 text-[#1A0B00] border-green-600' : 'bg-[#FFFFFF] text-[#6B7280] border-[#E5E7EB]'}`}
              >
                Active
              </button>
              <button 
                onClick={() => setStatusFilter('EXPIRED')}
                className={`px-3 py-1.5 rounded-full text-xs font-bold border transition-colors ${statusFilter === 'EXPIRED' ? 'bg-red-600 text-[#1A0B00] border-red-600' : 'bg-[#FFFFFF] text-[#6B7280] border-[#E5E7EB]'}`}
              >
                Expired
              </button>
            </div>
                  ...
                  return (
                    <div key={booking.id || booking._id || `booking-${idx}`}>
                      ...
                      <motion.div
                        ...
                        className={`w-full border ${isExpired ? 'bg-[#FFFFFF] border-[#E5E7EB]' : 'bg-gradient-to-br from-[#FF6D00] via-[#FFF3B0] to-[#D4AF37] border-[#B8860B] shadow-lg shadow-[#D4AF37]/40'} rounded-xl p-4 cursor-pointer hover:scale-[1.01] transition-transform active:scale-95 flex flex-col gap-3 relative overflow-hidden`}
                  >
                    {/* Left Accent Bar */}
