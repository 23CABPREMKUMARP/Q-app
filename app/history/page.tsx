          ...
          {searched && (
            <div className="grid grid-cols-2 gap-4 w-full md:w-auto relative z-10">
              <div className="bg-[#ffffff] border border-slate-200 shadow-sm text-black border border-slate-200 rounded-2xl p-4 min-w-[120px]">
                ...
                <p className="text-lg font-black text-[#A4E5E0]">₹{totalSpent}</p>
              </div>
              <div className="bg-[#ffffff] border border-slate-200 shadow-sm text-black border border-slate-200 rounded-2xl p-4 min-w-[120px]">
                ...
                {[
                  ...
                  <button
                    ...
                    className={`px-3 py-1.5 rounded-lg text-[9px] font-bold uppercase tracking-wider transition-all border ${
                      filterType === tab.id 
                        ? "bg-[#A4E5E0] text-black border-[#A4E5E0] shadow-sm" 
              ...
              {filteredHistory.length === 0 ? (
                ...
                filteredHistory.map((item) => (
                  <div 
                    ...
                    className={`bg-[#ffffff] rounded-2xl p-4 border border-slate-100 hover:border-[#A4E5E0] shadow-sm flex items-center justify-between gap-4 transition-all duration-300 ${item.type === "booking" ? "cursor-pointer" : "cursor-default"}`}
                  >
            ...
            >
              ...
              >
                ...
                <div className="w-full flex gap-3 mt-4 print:hidden">
                  <button 
                    onClick={handlePrint}
                    className="flex-[2] py-4 bg-[#ffffff] border border-slate-200 shadow-sm text-black hover:bg-[#A4E5E0] text-black rounded-2xl font-bold text-[10px] uppercase tracking-widest flex items-center justify-center gap-2 transition-all shadow-md active:scale-95 cursor-pointer"
                  >
                ...
                <button 
                  onClick={() => setSelectedBooking(null)}
                  className="absolute top-4 right-4 bg-[#ffffff] border border-slate-200 shadow-sm text-black text-black p-2.5 rounded-full hover:bg-[#A4E5E0] transition-all shadow-md"
                >
