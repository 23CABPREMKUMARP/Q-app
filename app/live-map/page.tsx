    ...
    <div className="relative w-screen h-screen overflow-hidden bg-[#e8eaed] select-none">
      ...
      <div className="absolute top-0 inset-x-0 z-[500] p-3 md:p-4 pointer-events-none">
        <div className="flex items-center gap-2 md:gap-3 pointer-events-auto max-w-xl mx-auto md:mx-0">
          ...
          {/* Search box */}
          <div className={`flex-1 bg-[#ffffff] rounded-full shadow-lg flex items-center gap-3 px-4 transition-all ${searchFocused ? "ring-2 ring-blue-400 shadow-xl" : ""}`}
            style={{ height: 48 }}>
            {searchFocused ? (
          ...
          <div className="w-10 h-10 rounded-full bg-[#18D2C7] flex items-center justify-center shadow-md flex-shrink-0">
      ...
      <div className="absolute right-3 md:right-4 z-[500] flex flex-col gap-3" style={{ bottom: drawerState === "full" ? "75%" : drawerState === "peek" ? 220 : 24 }}>
        ...
        <button
          ...
          disabled={locating}
          className={`w-12 h-12 bg-[#ffffff] rounded-2xl shadow-lg flex items-center justify-center transition-all active:scale-95 ${locating ? "opacity-60" : "hover:shadow-xl"} ${locationError ? "text-red-400" : "text-blue-500"}`}
        >
          {locating ? (
              ...
              return (
                <div className="px-5 pb-8 overflow-y-auto border-t border-gray-100 pt-5 space-y-4">
                  ...
                  <div className="bg-gray-900 rounded-2xl p-4 flex items-center gap-4">
                    ...
                    <Navigation size={16} className="text-[#18D2C7] flex-shrink-0" />
        ...
        {!selectedBus && (
          ...
          >
            ...
            <div className="bg-[#ffffff] rounded-full shadow-lg px-4 py-2.5 flex items-center gap-2.5">
              <Bus size={14} className="text-[#18D2C7]" />
