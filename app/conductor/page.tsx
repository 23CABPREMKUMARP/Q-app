...
export default function EnterpriseConductorPortal() {
  ...
  return (
    <SecureView>
      <div className="min-h-screen bg-[#FFF5E6] border border-[#E5E7EB] shadow-sm text-[#1A0B00] text-[#1A0B00] font-sans antialiased overflow-x-hidden flex flex-col md:flex-row">
      ...
      <AnimatePresence>
        {!isAuthenticated && (
          <motion.div 
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="fixed inset-0 z-[1000] bg-[#FFF5E6] border border-[#E5E7EB] shadow-sm text-[#1A0B00] flex flex-col items-center justify-center p-6 text-zinc-200 overflow-y-auto"
          >
            <div className="text-center space-y-4 max-w-md w-full p-8 border border-zinc-300 rounded-3xl bg-[#FFF5E6] border border-[#E5E7EB] shadow-sm text-[#1A0B00] shadow-2xl relative">
              ...
              <div className="w-16 h-16 bg-gradient-to-br from-orange-500 to-orange-600 rounded-3xl flex items-center justify-center mx-auto shadow-lg shadow-orange-600/30">
                <ShieldCheck className="text-[#1A0B00]" size={32} />
              </div>
              <h1 className="text-2xl font-black uppercase tracking-tight text-[#1A0B00]">Transit Console</h1>
              ...
              {!isLoaded || isCheckingAssignment ? (
                ...
                <div className="space-y-4 pt-4">
                  ...
                  <button onClick={() => router.push("/sign-in?redirect_url=/conductor")} className="w-full py-3 bg-orange-600 hover:bg-orange-700 text-[#1A0B00] font-black rounded-xl uppercase tracking-widest text-[10px]">
                    Sign In to Continue
                  </button>
                </div>
              ) : !isAssigned ? (
                <div className="space-y-4 pt-4">
                  ...
                  <div className="pt-4 space-y-3">
                    <button onClick={() => router.push("/")} className="w-full py-3 bg-[#FFF5E6] border border-[#E5E7EB] shadow-sm text-[#1A0B00] hover:bg-zinc-700 text-[#1A0B00] font-bold rounded-xl text-xs uppercase tracking-wider transition-all">
      ...
      {isAuthenticated && (
        <>
          {/* SIDEBAR FOR DESKTOP */}
          <aside className="hidden md:flex flex-col w-72 bg-[#FFF5E6] border border-[#E5E7EB] shadow-sm text-[#1A0B00] border-r border-zinc-300 p-6 space-y-6 shrink-0">
            ...
            <div className="h-px bg-[#FFF5E6] border border-[#E5E7EB] shadow-sm text-[#1A0B00]" />
            ...
            <div className="pt-4 border-t border-zinc-300 space-y-3">
              <div className="bg-[#FFF5E6] border border-[#E5E7EB] shadow-sm text-[#1A0B00] p-3.5 rounded-xl border border-zinc-300 text-[10px] space-y-1">
              ...
              <button 
                ...
                className="w-full py-3 bg-[#FFF5E6] border border-[#E5E7EB] shadow-sm text-[#1A0B00] hover:bg-zinc-755 border border-zinc-300 text-zinc-300 text-[10px] font-black uppercase tracking-wider rounded-xl transition-all active:scale-95"
              >
                Logout Shift
              </button>
            </div>
          ...
          {/* MOBILE HEADER */}
          <header className="md:hidden flex items-center justify-between px-5 py-4 bg-[#FFF5E6] border border-[#E5E7EB] shadow-sm text-[#1A0B00] border-b border-zinc-300 sticky top-0 z-50 shadow-md">
            <div className="flex items-center gap-3">
              <button 
                onClick={() => setMobileMenuOpen(true)}
                className="p-1.5 bg-[#FFF5E6] border border-[#E5E7EB] shadow-sm text-[#1A0B00] hover:bg-zinc-750 border border-zinc-300 rounded-lg text-zinc-300 mr-0.5"
              >
                <Menu size={16} />
              </button>
              <div className="flex items-center gap-2">
                ...
                <div>
                  <h2 className="text-[10px] font-black uppercase tracking-tight text-[#1A0B00] leading-tight">Console</h2>
            ...
            <div className="flex items-center gap-2">
              {offlineQueue.length > 0 && (
                <button 
                  ...
                  className="bg-[#FF6D00]/20 text-[#FF6D00] px-2 py-1 rounded-full text-[9px] font-black animate-pulse border border-[#FF6D00]/30"
                >
              ...
              <button 
                onClick={handleLogout}
                className="p-2 bg-[#FFF5E6] border border-[#E5E7EB] shadow-sm text-[#1A0B00] border border-zinc-300 rounded-xl text-zinc-405 transition-colors"
              >
            ...
            {mobileMenuOpen && (
              <div className="fixed inset-0 z-[100] md:hidden">
                ...
                <motion.div 
                  ...
                  className="absolute inset-0 bg-[#FFF5E6]/90 backdrop-blur-md backdrop-blur-sm"
                />
                ...
                <motion.div 
                  ...
                  className="absolute left-0 top-0 bottom-0 w-64 bg-[#FFF5E6] border border-[#E5E7EB] shadow-sm text-[#1A0B00] border-r border-zinc-300 p-6 flex flex-col justify-between"
                >
                  <div className="space-y-6">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        ...
                        <span className="font-black text-xs tracking-tight text-[#1A0B00] uppercase">Transit Menu</span>
                      </div>
                      <button onClick={() => setMobileMenuOpen(false)} className="text-zinc-500 hover:text-[#FFF5E6] p-1">
                        <X size={16} />
                      </button>
                    </div>
                  ...
                  <div className="pt-4 border-t border-zinc-300">
                    <button 
                      ...
                      className="w-full py-2.5 bg-[#FFF5E6] border border-[#E5E7EB] shadow-sm text-[#1A0B00] hover:bg-zinc-700 text-zinc-350 text-[10px] font-black uppercase tracking-wider rounded-xl transition-all"
                    >
                      Logout Shift
                    </button>
                  </div>
          ...
          {/* MAIN CONTENT AREA */}
          <div className="flex-1 flex flex-col min-h-screen overflow-y-auto bg-[#FFF5E6] border border-[#E5E7EB] shadow-sm text-[#1A0B00] pb-20 md:pb-6">
            
            {/* Top Stat Bar */}
            <div className="bg-[#FFF5E6] border border-[#E5E7EB] shadow-sm text-[#1A0B00] border-b border-zinc-300 p-4 px-6 flex flex-wrap gap-4 items-center justify-between relative">
              <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-4 text-xs font-bold text-zinc-600">
                ...
                <span className="text-[10px] bg-[#FFF5E6] border border-[#E5E7EB] shadow-sm text-[#1A0B00] border border-zinc-300 px-2 py-0.5 rounded text-orange-400 font-mono">
                  {tripStatus}
                </span>
              </div>
            </div>
            ...
            <div className="p-4 md:p-8 max-w-4xl w-full mx-auto space-y-6">
              ...
              {activeTab === "dashboard" && (
                <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-6">
                  ...
                  <div className="bg-[#FFF5E6] border border-[#E5E7EB] shadow-sm text-[#1A0B00] border border-zinc-300 rounded-3xl p-6 relative overflow-hidden flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div className="space-y-2">
                      <div className="flex items-center gap-2">
                        <span className="text-xs font-black uppercase text-orange-500 tracking-widest">Conductor</span>
                        <span className="text-[9px] bg-[#FFF5E6] border border-[#E5E7EB] shadow-sm text-[#1A0B00] text-zinc-600 px-2 py-0.5 rounded font-mono">Shift Active</span>
                      </div>
                    ...
                    <div className="flex flex-wrap gap-2 pt-2 md:pt-0">
                      <button 
                        ...
                        className="px-4 py-3 bg-[#FFF5E6] border border-[#E5E7EB] shadow-sm text-[#1A0B00] hover:bg-zinc-700 border border-zinc-300 rounded-xl text-[10px] font-black uppercase tracking-widest flex items-center gap-2 transition-all active:scale-95"
                      >
                      ...
                      <button 
                        ...
                        className="px-4 py-3 bg-orange-600 hover:bg-orange-700 rounded-xl text-[10px] font-black uppercase tracking-widest flex items-center gap-2 transition-all active:scale-95 shadow-md shadow-orange-600/10 text-[#1A0B00]"
                      >
                        <Bus size={12} />
                        Cycle Status
                      </button>
                  ...
                  <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                    {[
                      ...
                      { title: "Bus Occupancy", val: `${occupancy}/50`, desc: `Occupied: ${Math.round((occupancy/50)*100)}%`, color: "text-[#FF6D00]", icon: Bus },
                      ...
                      return (
                        <div key={i} className="bg-[#FFF5E6] border border-[#E5E7EB] shadow-sm text-[#1A0B00] border border-zinc-300 p-5 rounded-2xl space-y-2 shadow-md">
                          <div className="flex justify-between items-center text-zinc-500">
                            <span className="text-[9px] font-bold uppercase tracking-widest">{stat.title}</span>
                            <Icon size={14} className={stat.color} />
                          </div>
                          <h3 className="text-2xl font-black tracking-tight text-[#1A0B00]">{stat.val}</h3>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {/* Shift Logs */}
                    <div className="bg-[#FFF5E6] border border-[#E5E7EB] shadow-sm text-[#1A0B00] border border-zinc-300 rounded-3xl p-6 space-y-4">
                      <div className="flex justify-between items-center">
                        <h3 className="text-xs font-black uppercase tracking-widest text-zinc-600">Shift Activity Log</h3>
                    ...
                    <div className="bg-[#FFF5E6] border border-[#E5E7EB] shadow-sm text-[#1A0B00] border border-zinc-300 rounded-3xl p-6 space-y-4">
                      <div className="flex justify-between items-center">
                        <h3 className="text-xs font-black uppercase tracking-widest text-zinc-600">Control Broadcasts</h3>
                        <span className="text-[9px] text-orange-500 font-black animate-pulse">LIVE</span>
                      </div>
                      <div className="space-y-3">
                        {notifications.slice(0, 2).map((n) => (
                          <div key={n.id} className="bg-zinc-955 p-3 rounded-xl border border-zinc-300 space-y-1">
                            <div className="flex justify-between items-center">
              ...
              {activeTab === "scan" && (
                <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-6">
                  <div className="bg-[#FFF5E6] border border-[#E5E7EB] shadow-sm text-[#1A0B00] border border-zinc-300 rounded-3xl p-6 text-center space-y-6 relative overflow-hidden">
                    ...
                    {!isScanning ? (
                      <div className="flex flex-col items-center justify-center py-6 gap-6">
                        ...
                        <div className="space-y-1">
                          <h2 className="text-xl font-black uppercase text-[#1A0B00] tracking-tight">QR Scanner Engaged</h2>
                        ...
                        <button 
                          ...
                          className="w-full max-w-xs bg-orange-600 hover:bg-orange-700 text-[#1A0B00] py-4 rounded-xl font-black uppercase tracking-widest text-xs flex items-center justify-center gap-3 active:scale-95 transition-all shadow-lg shadow-orange-600/10 cursor-pointer"
                        >
                          <Camera size={18} />
                      ...
                      <div className="space-y-4 max-w-sm mx-auto">
                        <div id="reader" className="overflow-hidden rounded-2xl border-4 border-orange-600 shadow-inner bg-[#FFF5E6] border border-[#E5E7EB] text-[#1A0B00]" />
                        <button 
                          onClick={() => setIsScanning(false)}
                          className="w-full bg-[#FFF5E6] border border-[#E5E7EB] shadow-sm text-[#1A0B00] hover:bg-zinc-800 border border-zinc-300 text-zinc-600 py-3 rounded-xl font-bold uppercase tracking-widest text-[9px]"
                        >
                          Cancel Scanner
                        </button>
                      </div>
                  ...
                  <AnimatePresence mode="wait">
                    {validating && (
                      <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="bg-[#FFF5E6] border border-[#E5E7EB] shadow-sm text-[#1A0B00] border border-zinc-300 rounded-3xl p-8 text-center space-y-4">
                        ...
                        className={`rounded-[32px] p-6 border-2 transition-all ${
                          scanResult.success 
                            ...
                            : scanResult.message?.includes("Used")
                              ? "bg-amber-950/20 border-[#FF6D00]/50 shadow-[0_0_30px_rgba(245,158,11,0.05)]"
                              : scanResult.message?.includes("Expired")
                                ? "bg-[#FFF5E6] border border-[#E5E7EB] shadow-sm text-[#1A0B00] border-zinc-300 shadow-[0_0_30px_rgba(100,116,139,0.05)]"
                        ...
                        <div className="flex flex-col items-center gap-6">
                          <div className="flex items-center gap-3">
                            {scanResult.success ? (
                              ...
                              <AlertTriangle size={40} className="text-[#FF6D00]" />
                            ) : scanResult.message?.includes("Expired") ? (
                            ...
                            <div className="space-y-1 text-left">
                              <h3 className={`text-xl font-black uppercase tracking-tight ${
                                scanResult.success ? "text-[#22C55E]" : scanResult.message?.includes("Used") ? "text-[#FF6D00]" : scanResult.message?.includes("Expired") ? "text-zinc-600" : "text-[#EF4444]"
                              }`}>
                          ...
                          {scanResult.booking?.passengers && scanResult.booking.passengers.length > 0 && (scanResult.booking.boarding_point === "Combined Journey" || scanResult.booking.boardingPoint === "Combined Journey") ? (
                            <div className="w-full bg-[#FFF5E6] border border-[#E5E7EB] shadow-sm text-[#1A0B00] border border-zinc-300 rounded-xl p-4 mt-2">
                              ...
                              <div className="space-y-3">
                                {scanResult.booking.passengers.map((p: any, idx: number) => (
                                  <div key={idx} className="text-xs bg-[#FFF5E6] border border-[#E5E7EB] shadow-sm text-[#1A0B00] border border-zinc-300 rounded-lg p-3">
                  ...
                  <div className="bg-[#FFF5E6] border border-[#E5E7EB] shadow-sm text-[#1A0B00] border border-zinc-300 rounded-3xl p-6 space-y-4">
                    <h3 className="text-xs font-black uppercase tracking-widest text-zinc-600">Manual Ticket ID Entry</h3>
                    <div className="flex gap-2">
                      <input 
                        type="text" 
                        placeholder="E.g. TB-601090"
                        id="manualTicketInput"
                        className="flex-1 bg-[#FFF5E6] border border-[#E5E7EB] shadow-sm text-[#1A0B00] border border-zinc-300 rounded-xl py-3 px-4 focus:outline-none focus:ring-1 focus:ring-orange-500 text-sm text-[#1A0B00] placeholder:text-zinc-750 font-mono"
                      />
                      <button
                        onClick={() => {
                        ...
                        className="px-5 bg-orange-600 hover:bg-orange-700 text-[#1A0B00] rounded-xl text-[10px] font-black uppercase tracking-wider shadow-md shadow-orange-600/10"
                      >
                        Verify
                      </button>
                    </div>
              ...
              {activeTab === "ticketing" && (
                <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {/* form card */}
                    <div className="bg-[#FFF5E6] border border-[#E5E7EB] shadow-sm text-[#1A0B00] border border-zinc-300 rounded-3xl p-6 space-y-5 text-left">
                      <h3 className="text-xs font-black uppercase tracking-widest text-zinc-600 border-b border-zinc-300 pb-3">New Passenger Ticket</h3>
                      <form onSubmit={handleIssueTicket} className="space-y-4">
                        ...
                        <div className="space-y-1">
                          ...
                          <select 
                            ...
                            className="w-full bg-zinc-955 border border-zinc-300 rounded-xl py-3 px-4 focus:outline-none focus:ring-1 focus:ring-orange-500 text-sm text-[#1A0B00]"
                          >
                            {STOPS.map((s) => (
                        ...
                        <div className="space-y-1">
                          ...
                          <div className="flex items-center gap-3 bg-zinc-955 border border-zinc-300 rounded-xl p-1.5 max-w-[150px] justify-between">
                            <button
                              type="button"
                              onClick={() => {
                              ...
                              className="w-9 h-9 bg-[#FFF5E6] border border-[#E5E7EB] shadow-sm text-[#1A0B00] border border-zinc-300 text-zinc-300 rounded-lg flex items-center justify-center hover:bg-zinc-800 cursor-pointer"
                            >
                              <Minus size={14} />
                            </button>
                            <span className="text-sm font-black text-[#1A0B00]">{obQuantity}</span>
                            <button
                              type="button"
                              onClick={() => {
                          ...
                          <div className="grid grid-cols-4 gap-2">
                            {["Cash", "UPI", "PhonePe", "GPay"].map((p) => (
                              <button
                                ...
                                className={`py-3 text-[10px] font-black uppercase tracking-wider rounded-xl border transition-all ${obPaymentMode === p ? "bg-orange-600/10 border-orange-500 text-orange-500" : "bg-zinc-955 border-zinc-300 text-zinc-500"}`}
                              >
                                {p}
                              </button>
                            ))}
                        ...
                        <div className="pt-2">
                          <div className="flex justify-between items-center bg-zinc-955 p-4 rounded-xl border border-zinc-300 mb-4">
                            <span className="text-[10px] font-black text-zinc-500 uppercase tracking-wider">Calculated Fare</span>
                            <span className="text-xl font-black text-[#1A0B00]">₹{ticketFare}</span>
                          </div>

                          <button
                            type="submit"
                            disabled={obBoarding === obDestination}
                            className="w-full py-4 bg-orange-600 hover:bg-orange-700 text-[#1A0B00] rounded-xl font-black uppercase tracking-widest text-xs shadow-lg shadow-orange-600/15 disabled:opacity-40 cursor-pointer"
                          >
                            Print & Issue Ticket
                          </button>
                        </div>
                      ...
                      <AnimatePresence mode="wait">
                        {obSuccessTicket ? (
                          <motion.div 
                            ...
                            className="w-full max-w-[280px] bg-yellow-100 bg-gradient-to-br from-yellow-100 to-yellow-200 text-[#1A0B00] p-6 rounded-2xl shadow-xl space-y-4 border border-yellow-300 relative font-mono text-xs overflow-hidden"
                          >
                            ...
                            <div className="border-t-2 border-dashed border-zinc-800/20 pt-4 flex flex-col items-center gap-3">
                              <div className="p-2 bg-[#FFF5E6] rounded-xl shadow-inner border border-yellow-300/40">
                                <QRCodeSVG 
                          ...
                          <div className="text-center p-8 bg-[#1A0B00]/40 border-2 border-dashed border-zinc-300 rounded-3xl w-full py-16 space-y-3">
              ...
              {activeTab === "passengers" && (
                <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-6 text-left">
                  ...
                  {/* Search and Filters */}
                  <div className="bg-[#FFF5E6] border border-[#E5E7EB] shadow-sm text-[#1A0B00] border border-zinc-300 rounded-3xl p-5 space-y-4">
                    <div className="flex gap-2">
                  ...
                  <div className="bg-[#FFF5E6] border border-[#E5E7EB] shadow-sm text-[#1A0B00] border border-zinc-300 rounded-3xl overflow-hidden shadow-md">
                    <div className="overflow-x-auto">
                      <table className="w-full text-left text-xs">
                        <thead className="bg-[#FFF5E6] border border-[#E5E7EB] shadow-sm text-[#1A0B00] border-b border-zinc-300 text-[9px] font-black uppercase text-zinc-500 tracking-wider">
                          <tr>
                          ...
                          {filteredPassengers.length > 0 ? (
                            filteredPassengers.map((p, i) => (
                              <tr key={i} className="hover:bg-zinc-850/25 transition-colors">
                                <td className="p-4 px-6 font-mono font-bold text-zinc-600">{p.ticketId}</td>
                ...
                <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-6 text-left">
                  <div className="bg-[#FFF5E6] border border-[#E5E7EB] shadow-sm text-[#1A0B00] border border-zinc-300 rounded-3xl p-6 space-y-4">
                    <div className="flex justify-between items-center border-b border-zinc-300 pb-3">
                      <div>
                        <h3 className="text-xs font-black uppercase tracking-widest text-zinc-600">Live Occupancy Monitor</h3>
                        <p className="text-[10px] text-zinc-500">Tap seats to manually toggle boarded state</p>
                      </div>
                      
                      <div className="text-right">
                        <span className="text-2xl font-black text-[#1A0B00]">{occupancy}/50</span>
                    ...
                    <div className="flex gap-4 text-[9px] font-black uppercase tracking-wider text-zinc-500">
                      ...
                      <div className="flex items-center gap-1.5">
                        <div className="w-3.5 h-3.5 bg-[#FFF5E6] border border-[#E5E7EB] shadow-sm text-[#1A0B00] border border-zinc-300 rounded" />
                    ...
                    <div className="bg-zinc-955 border border-zinc-850 p-6 rounded-2xl relative overflow-hidden">
                      ...
                      <div className="flex justify-between items-center border-b border-zinc-300 pb-4 mb-6">
                        <div className="w-8 h-8 rounded-full border-4 border-dashed border-zinc-300 flex items-center justify-center">
                          <div className="w-3 h-3 bg-[#FFF5E6] border border-[#E5E7EB] shadow-sm text-[#1A0B00] rounded-full" />
                        </div>
                            ...
                            return (
                              <React.Fragment key={`aisle-${idx}`}>
                                ...
                                <button
                                  ...
                                  className={`h-9 rounded-xl border text-[9px] font-bold flex items-center justify-center transition-all active:scale-90 cursor-pointer ${isOccupied ? "bg-orange-600 border-orange-500 text-[#1A0B00] shadow-md shadow-orange-600/10" : "bg-zinc-955 border-zinc-300 text-zinc-700 hover:border-zinc-700"}`}
                                >
                                  S{seatNum}
                                </button>
                              </React.Fragment>
              ...
              {activeTab === "gps" && (
                <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-5 text-left">
                  ...
                  <div className="bg-[#FFF5E6] border border-[#E5E7EB] shadow-sm text-[#1A0B00] border border-zinc-300 rounded-3xl p-6">
                    <div className="flex items-center justify-between mb-5">
                      <div className="flex items-center gap-3">
                        <div className={`w-12 h-12 rounded-2xl flex items-center justify-center transition-all ${
                          gpsState.status === 'broadcasting'
                            ? 'bg-[#FF6D00] text-[#1A0B00] shadow-lg shadow-[#FF6D00]/30'
                            : gpsState.status === 'no_permission'
                            ? 'bg-[#EF4444]/10 border border-[#EF4444]/20 text-[#EF4444]'
                            : 'bg-[#FFF5E6] border border-[#E5E7EB] shadow-sm text-[#1A0B00] text-zinc-500 border border-zinc-300'
                        }`}>
                          {gpsState.status === 'broadcasting'
                        ...
                        <div>
                          <h3 className="text-sm font-black text-[#1A0B00]">GPS Tracker</h3>
                          <p className={`text-[9px] font-bold uppercase tracking-widest ${
                            gpsState.status === 'broadcasting' ? 'text-[#FF6D00]' :
                            gpsState.status === 'error' ? 'text-[#EF4444]' :
                            gpsState.status === 'no_permission' ? 'text-[#FF6D00]' :
                            'text-zinc-500'
                          }`}>
                      ...
                      <button
                        ...
                        className={`px-5 py-3 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all active:scale-95 disabled:opacity-40 ${
                          gpsEnabled
                            ? 'bg-[#EF4444] hover:bg-red-600 text-[#1A0B00] shadow-lg shadow-[#EF4444]/30'
                            : 'bg-[#FF6D00] hover:bg-[#FF6D00] text-[#1A0B00] shadow-lg shadow-[#FF6D00]/30'
                        }`}
                      >
                    ...
                    <div className="grid grid-cols-2 gap-3 font-mono">
                      <div className="bg-[#FFF5E6] border border-[#E5E7EB] shadow-sm text-[#1A0B00] rounded-xl p-3 border border-zinc-300">
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    <div className="bg-[#FFF5E6] border border-[#E5E7EB] shadow-sm text-[#1A0B00] border border-zinc-300 rounded-2xl p-4 text-center">
                      <Gauge size={18} className="text-[#FF6D00] mx-auto mb-2" />
                      <p className="text-2xl font-black text-[#1A0B00]">{gpsState.speed || speed}</p>
                      <p className="text-[8px] text-zinc-500 uppercase tracking-widest font-bold mt-0.5">km/h</p>
                    </div>
                    <div className="bg-[#FFF5E6] border border-[#E5E7EB] shadow-sm text-[#1A0B00] border border-zinc-300 rounded-2xl p-4 text-center">
                      <Radio size={18} className="text-[#FF6D00] mx-auto mb-2" />
                      <p className="text-2xl font-black text-[#1A0B00]">{gpsState.updateCount}</p>
                      <p className="text-[8px] text-zinc-500 uppercase tracking-widest font-bold mt-0.5">Updates</p>
                    </div>
                    <div className="bg-[#FFF5E6] border border-[#E5E7EB] shadow-sm text-[#1A0B00] border border-zinc-300 rounded-2xl p-4 text-center">
                      <Signal size={18} className="text-[#FF6D00] mx-auto mb-2" />
                      <p className="text-[11px] font-black text-[#1A0B00]">{gpsState.accuracy ? `${Math.round(gpsState.accuracy)}m` : '—'}</p>
                      <p className="text-[8px] text-zinc-500 uppercase tracking-widest font-bold mt-0.5">Accuracy</p>
                    </div>
                  </div>

                  {/* Current Route */}
                  <div className="bg-[#FFF5E6] border border-[#E5E7EB] shadow-sm text-[#1A0B00] border border-zinc-300 rounded-2xl p-4 flex items-center gap-3">
                    <Bus size={20} className="text-[#FF6D00] flex-shrink-0" />
                    <div className="flex-1 min-w-0">
                      <p className="text-[9px] font-bold text-zinc-500 uppercase tracking-widest">Current Route</p>
                      <p className="text-sm font-black text-[#1A0B00] truncate">{assignedRouteName || 'Not Assigned'}</p>
                    </div>
                    <div className={`text-[9px] font-black px-2.5 py-1 rounded-full uppercase tracking-widest ${
                      tripStatus === 'Trip Started' || tripStatus === 'Boarding'
                        ...
                        : 'bg-[#FFF5E6] border border-[#E5E7EB] shadow-sm text-[#1A0B00] text-zinc-600'
                    }`}>{tripStatus}</div>
                  </div>

                  {/* Trip Status Controls */}
                  <div className="bg-[#FFF5E6] border border-[#E5E7EB] shadow-sm text-[#1A0B00] border border-zinc-300 rounded-2xl p-5 space-y-3">
                    <h3 className="text-[10px] font-black uppercase tracking-widest text-zinc-600">Update Trip Status</h3>
                        ...
                        return (
                          <button
                            ...
                            className={`flex flex-col items-center justify-center p-3 rounded-xl border transition-all text-center gap-1.5 cursor-pointer ${
                              isActive ? 'bg-orange-600 border-orange-500 text-[#1A0B00] shadow-md' : 'bg-[#FFF5E6] border border-[#E5E7EB] shadow-sm text-[#1A0B00] border-zinc-300 text-zinc-500 hover:border-zinc-700 hover:text-zinc-300'
                            }`}
                          >
                            <Icon size={16} />
              ...
              {activeTab === "collections" && (
                <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-6 text-left">
                  <div className="bg-[#FFF5E6] border border-[#E5E7EB] shadow-sm text-[#1A0B00] border border-zinc-300 rounded-3xl p-6 space-y-4">
                    <h3 className="text-xs font-black uppercase tracking-widest text-zinc-600 border-b border-zinc-300 pb-3">Collection Summary</h3>
                  ...
                  <div className="bg-[#FFF5E6] border border-[#E5E7EB] shadow-sm text-[#1A0B00] border border-zinc-300 rounded-3xl p-6 space-y-4">
                    <h3 className="text-xs font-black uppercase tracking-widest text-zinc-600">Shift Handover Operations</h3>
                    ...
                    <button
                      ...
                      className="w-full py-4 bg-orange-600 hover:bg-orange-700 text-[#1A0B00] rounded-xl font-black uppercase tracking-widest text-[9px] active:scale-95 shadow-md shadow-orange-600/10 cursor-pointer"
                    >
                ...
                <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-6 text-left">
                  ...
                  <div className="bg-[#FFF5E6] border border-[#E5E7EB] shadow-sm text-[#1A0B00] border border-zinc-300 rounded-3xl p-6 space-y-4">
                    <div className="flex justify-between items-center">
                      ...
                      <button
                        ...
                        className={`px-4 py-2.5 rounded-xl text-[9px] font-black uppercase tracking-widest transition-all cursor-pointer ${isOffline ? "bg-green-600 text-[#1A0B00]" : "bg-[#EF4444]/10 border border-[#EF4444]/20 text-[#EF4444]"}`}
                      >
                  ...
                  <div className="bg-[#FFF5E6] border border-[#E5E7EB] shadow-sm text-[#1A0B00] border border-zinc-300 rounded-3xl p-6 space-y-4">
                    <div className="flex justify-between items-center border-b border-zinc-300 pb-3">
                      ...
                      <span className="text-[10px] bg-[#FFF5E6] border border-[#E5E7EB] shadow-sm text-[#1A0B00] border border-zinc-300 px-2 py-0.5 rounded font-mono text-zinc-600">
                    ...
                    {offlineQueue.length > 0 ? (
                      <div className="space-y-3">
                        ...
                        <button
                          ...
                          className="w-full py-4 mt-4 bg-orange-600 hover:bg-orange-700 text-[#1A0B00] rounded-xl font-black uppercase tracking-widest text-[9px] active:scale-95 shadow-md shadow-orange-600/10 disabled:opacity-40 cursor-pointer"
                        >
              ...
              {activeTab === "issues" && (
                <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-6 text-left">
                  <div className="bg-[#FFF5E6] border border-[#E5E7EB] shadow-sm text-[#1A0B00] border border-zinc-300 rounded-3xl p-6 space-y-4">
                    <h3 className="text-xs font-black uppercase tracking-widest text-zinc-600 border-b border-zinc-300 pb-3">Report Transit Incident</h3>
                    ...
                    <form onSubmit={handleReportIssue} className="space-y-4">
                      ...
                      <button
                        type="submit"
                        className="w-full py-4 bg-orange-600 hover:bg-orange-700 text-[#1A0B00] rounded-xl font-black uppercase tracking-widest text-[9px] shadow-lg shadow-orange-600/15 cursor-pointer"
                      >
              ...
              {activeTab === "notifications" && (
                <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-6 text-left">
                  <div className="bg-[#FFF5E6] border border-[#E5E7EB] shadow-sm text-[#1A0B00] border border-zinc-300 rounded-3xl p-6 space-y-4">
                    <h3 className="text-xs font-black uppercase tracking-widest text-zinc-600 border-b border-zinc-300 pb-3">Announcements Inbox</h3>
          ...
          <nav className="md:hidden fixed bottom-0 left-0 right-0 bg-[#FFF5E6] border border-[#E5E7EB] shadow-sm text-[#1A0B00] border-t border-zinc-300 px-6 py-3.5 flex items-center justify-between z-50 safe-bottom shadow-lg">
             {[
          ...
          <AnimatePresence>
            {showQR && (
              <motion.div 
                ...
                animate={{ opacity: 1 }}
                exit={{ opacity: 0 }}
                className="fixed inset-0 z-[1000] bg-[#1A0B00]/90 backdrop-blur-xl flex flex-col items-center justify-center p-6"
              >
                 <button 
                   onClick={() => setShowQR(false)}
                   className="absolute top-8 right-8 w-12 h-12 bg-[#FFF5E6] border border-[#E5E7EB] shadow-sm text-[#1A0B00] hover:bg-zinc-700 rounded-full flex items-center justify-center text-[#1A0B00] border border-zinc-750"
                 >
                   <X size={20} />
                 </button>
