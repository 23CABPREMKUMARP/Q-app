...
export default function EnterpriseConductorPortal() {
  ...
  return (
    <SecureView>
      <div className="min-h-screen bg-[#FFFFFF] border border-[#E5E7EB] shadow-sm text-[#1A0B00] text-[#1A0B00] font-sans antialiased overflow-x-hidden flex flex-col md:flex-row">
              ...
              {!isLoaded || isCheckingAssignment ? (
                ...
                <div className="space-y-4 pt-4">
                  ...
                  <div className="pt-4 space-y-3">
                    <button onClick={() => router.push("/")} className="w-full py-3 bg-[#FFFFFF] border border-[#E5E7EB] shadow-sm text-[#1A0B00] hover:bg-zinc-700 text-[#1A0B00] font-bold rounded-xl text-xs uppercase tracking-wider transition-all">
      ...
      {isAuthenticated && (
        <>
          {/* SIDEBAR FOR DESKTOP */}
          <aside className="hidden md:flex flex-col w-72 bg-[#FFFFFF] border border-[#E5E7EB] shadow-sm text-[#1A0B00] border-r border-zinc-300 p-6 space-y-6 shrink-0">
          ...
          {/* MOBILE HEADER */}
          <header className="md:hidden flex items-center justify-between px-5 py-4 bg-[#FFFFFF] border border-[#E5E7EB] shadow-sm text-[#1A0B00] border-b border-zinc-300 sticky top-0 z-50 shadow-md">
            <div className="flex items-center gap-3">
              <button 
            ...
            <div className="flex items-center gap-2">
              ...
              <button 
                onClick={handleLogout}
                className="p-2 bg-[#FFFFFF] border border-[#E5E7EB] shadow-sm text-[#1A0B00] border border-zinc-300 rounded-xl text-zinc-405 transition-colors"
              >
            ...
            {mobileMenuOpen && (
              <div className="fixed inset-0 z-[100] md:hidden">
                ...
                <motion.div 
                  ...
                  className="absolute inset-0 bg-[#FFFFFF]/90 backdrop-blur-md backdrop-blur-sm"
                />
                ...
                <motion.div 
                  ...
                  className="absolute left-0 top-0 bottom-0 w-64 bg-[#FFFFFF] border border-[#E5E7EB] shadow-sm text-[#1A0B00] border-r border-zinc-300 p-6 flex flex-col justify-between"
                >
                  ...
                  <div className="pt-4 border-t border-zinc-300">
                    <button 
                      ...
                      className="w-full py-2.5 bg-[#FFFFFF] border border-[#E5E7EB] shadow-sm text-[#1A0B00] hover:bg-zinc-700 text-zinc-350 text-[10px] font-black uppercase tracking-wider rounded-xl transition-all"
                    >
                      Logout Shift
                    </button>
                  </div>
          ...
          {/* MAIN CONTENT AREA */}
          <div className="flex-1 flex flex-col min-h-screen overflow-y-auto bg-[#FFFFFF] border border-[#E5E7EB] shadow-sm text-[#1A0B00] pb-20 md:pb-6">
            
            {/* Top Stat Bar */}
            <div className="bg-[#FFFFFF] border border-[#E5E7EB] shadow-sm text-[#1A0B00] border-b border-zinc-300 p-4 px-6 flex flex-wrap gap-4 items-center justify-between relative">
              <div className="flex items-center gap-3">
            ...
            <div className="p-4 md:p-8 max-w-4xl w-full mx-auto space-y-6">
              ...
              {activeTab === "dashboard" && (
                <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-6">
                  ...
                  <div className="bg-[#FFFFFF] border border-[#E5E7EB] shadow-sm text-[#1A0B00] border border-zinc-300 rounded-3xl p-6 relative overflow-hidden flex flex-col md:flex-row md:items-center justify-between gap-4">
                    ...
                    <div className="flex flex-wrap gap-2 pt-2 md:pt-0">
                      <button 
                        ...
                        className="px-4 py-3 bg-[#FFFFFF] border border-[#E5E7EB] shadow-sm text-[#1A0B00] hover:bg-zinc-700 border border-zinc-300 rounded-xl text-[10px] font-black uppercase tracking-widest flex items-center gap-2 transition-all active:scale-95"
                      >
                  ...
                  <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                    {[
                      ...
                      return (
                        <div key={i} className="bg-[#FFFFFF] border border-[#E5E7EB] shadow-sm text-[#1A0B00] border border-zinc-300 p-5 rounded-2xl space-y-2 shadow-md">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {/* Shift Logs */}
                    <div className="bg-[#FFFFFF] border border-[#E5E7EB] shadow-sm text-[#1A0B00] border border-zinc-300 rounded-3xl p-6 space-y-4">
              ...
              {activeTab === "scan" && (
                <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-6">
                  <div className="bg-[#FFFFFF] border border-[#E5E7EB] shadow-sm text-[#1A0B00] border border-zinc-300 rounded-3xl p-6 text-center space-y-6 relative overflow-hidden">
                    ...
                    {!isScanning ? (
                      ...
                      <div className="space-y-4 max-w-sm mx-auto">
                        <div id="reader" className="overflow-hidden rounded-2xl border-4 border-orange-600 shadow-inner bg-[#FFFFFF] border border-[#E5E7EB] text-[#1A0B00]" />
                        <button 
                          onClick={() => setIsScanning(false)}
                          className="w-full bg-[#FFFFFF] border border-[#E5E7EB] shadow-sm text-[#1A0B00] hover:bg-zinc-800 border border-zinc-300 text-zinc-600 py-3 rounded-xl font-bold uppercase tracking-widest text-[9px]"
                        >
                          Cancel Scanner
                        </button>
                      </div>
                  ...
                  <AnimatePresence mode="wait">
                    {validating && (
                      <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="bg-[#FFFFFF] border border-[#E5E7EB] shadow-sm text-[#1A0B00] border border-zinc-300 rounded-3xl p-8 text-center space-y-4">
                          ...
                          scanResult.success 
                            ...
                            : scanResult.message?.includes("Used")
                              ...
                              : scanResult.message?.includes("Expired")
                                ? "bg-[#FFFFFF] border border-[#E5E7EB] shadow-sm text-[#1A0B00] border-zinc-300 shadow-[0_0_30px_rgba(100,116,139,0.05)]"
                      ...
                      >
                        <div className="flex flex-col items-center gap-6">
                          ...
                          {scanResult.booking?.passengers && scanResult.booking.passengers.length > 0 && (scanResult.booking.boarding_point === "Combined Journey" || scanResult.booking.boardingPoint === "Combined Journey") ? (
                            <div className="w-full bg-[#FFFFFF] border border-[#E5E7EB] shadow-sm text-[#1A0B00] border border-zinc-300 rounded-xl p-4 mt-2">
                  ...
                  <div className="bg-[#FFFFFF] border border-[#E5E7EB] shadow-sm text-[#1A0B00] border border-zinc-300 rounded-3xl p-6 space-y-4">
                    ...
                    <div className="flex gap-2">
                      <input 
                        ...
                        className="flex-1 bg-[#FFFFFF] border border-[#E5E7EB] shadow-sm text-[#1A0B00] border border-zinc-300 rounded-xl py-3 px-4 focus:outline-none focus:ring-1 focus:ring-orange-500 text-sm text-[#1A0B00] placeholder:text-zinc-750 font-mono"
                      />
                      <button
                        onClick={() => {
              ...
              {activeTab === "ticketing" && (
                <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {/* form card */}
                    <div className="bg-[#FFFFFF] border border-[#E5E7EB] shadow-sm text-[#1A0B00] border border-zinc-300 rounded-3xl p-6 space-y-5 text-left">
                        ...
                        {obSuccessTicket ? (
                          ...
                          >
                            ...
                            <div className="text-center border-b-2 border-dashed border-zinc-800/20 pb-4">
                              <h4 className="font-black tracking-widest uppercase text-[10px]">Smart Tamizha Ticket</h4>
              ...
              {activeTab === "passengers" && (
                <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-6 text-left">
                  ...
                  {/* Search and Filters */}
                  <div className="bg-[#FFFFFF] border border-[#E5E7EB] shadow-sm text-[#1A0B00] border border-zinc-300 rounded-3xl p-5 space-y-4">
                    <div className="flex gap-2">
                  ...
                  <div className="bg-[#FFFFFF] border border-[#E5E7EB] shadow-sm text-[#1A0B00] border border-zinc-300 rounded-3xl overflow-hidden shadow-md">
                    <div className="overflow-x-auto">
                      <table className="w-full text-left text-xs">
                        <thead className="bg-[#FFFFFF] border border-[#E5E7EB] shadow-sm text-[#1A0B00] border-b border-zinc-300 text-[9px] font-black uppercase text-zinc-500 tracking-wider">
                          <tr>
                ...
                <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-6 text-left">
                  <div className="bg-[#FFFFFF] border border-[#E5E7EB] shadow-sm text-[#1A0B00] border border-zinc-300 rounded-3xl p-6 space-y-4">
                    ...
                    <div className="flex gap-4 text-[9px] font-black uppercase tracking-wider text-zinc-500">
                      ...
                      <div className="flex items-center gap-1.5">
                        <div className="w-3.5 h-3.5 bg-[#FFFFFF] border border-[#E5E7EB] shadow-sm text-[#1A0B00] border border-zinc-300 rounded" />
                    ...
                    <div className="bg-zinc-955 border border-zinc-850 p-6 rounded-2xl relative overflow-hidden">
                      ...
                      <div className="flex justify-between items-center border-b border-zinc-300 pb-4 mb-6">
                        <div className="w-8 h-8 rounded-full border-4 border-dashed border-zinc-300 flex items-center justify-center">
                          <div className="w-3 h-3 bg-[#FFFFFF] border border-[#E5E7EB] shadow-sm text-[#1A0B00] rounded-full" />
                        </div>
              ...
              {activeTab === "gps" && (
                <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-5 text-left">
                  ...
                  <div className="bg-[#FFFFFF] border border-[#E5E7EB] shadow-sm text-[#1A0B00] border border-zinc-300 rounded-3xl p-6">
                      ...
                      <div className="flex items-center gap-3">
                        <div className={`w-12 h-12 rounded-2xl flex items-center justify-center transition-all ${
                          gpsState.status === 'broadcasting'
                            ...
                            : 'bg-[#FFFFFF] border border-[#E5E7EB] shadow-sm text-[#1A0B00] text-zinc-500 border border-zinc-300'
                        }`}>
                          {gpsState.status === 'broadcasting'
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    <div className="bg-[#FFFFFF] border border-[#E5E7EB] shadow-sm text-[#1A0B00] border border-zinc-300 rounded-2xl p-4 text-center">
                  ...
                  {/* Current Route */}
                  <div className="bg-[#FFFFFF] border border-[#E5E7EB] shadow-sm text-[#1A0B00] border border-zinc-300 rounded-2xl p-4 flex items-center gap-3">
                    ...
                    <div className={`text-[9px] font-black px-2.5 py-1 rounded-full uppercase tracking-widest ${
                      tripStatus === 'Trip Started' || tripStatus === 'Boarding'
                        ...
                        : 'bg-[#FFFFFF] border border-[#E5E7EB] shadow-sm text-[#1A0B00] text-zinc-600'
                    }`}>{tripStatus}</div>
                  </div>

                  {/* Trip Status Controls */}
                  <div className="bg-[#FFFFFF] border border-[#E5E7EB] shadow-sm text-[#1A0B00] border border-zinc-300 rounded-2xl p-5 space-y-3">
                ...
                <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-6 text-left">
                  ...
                  <div className="bg-[#FFFFFF] border border-[#E5E7EB] shadow-sm text-[#1A0B00] border border-zinc-300 rounded-3xl p-6 space-y-4">
                    <div className="flex justify-between items-center border-b border-zinc-300 pb-3">
                      ...
                      <span className="text-[10px] bg-[#FFFFFF] border border-[#E5E7EB] shadow-sm text-[#1A0B00] border border-zinc-300 px-2 py-0.5 rounded font-mono text-zinc-600">
          ...
          <nav className="md:hidden fixed bottom-0 left-0 right-0 bg-[#FFFFFF] border border-[#E5E7EB] shadow-sm text-[#1A0B00] border-t border-zinc-300 px-6 py-3.5 flex items-center justify-between z-50 safe-bottom shadow-lg">
             {[
            ...
            {showQR && (
              ...
              >
                 <button 
                   ...
                   className="absolute top-8 right-8 w-12 h-12 bg-[#FFFFFF] border border-[#E5E7EB] shadow-sm text-[#1A0B00] hover:bg-zinc-700 rounded-full flex items-center justify-center text-[#1A0B00] border border-zinc-750"
                 >
                   <X size={20} />
                 </button>
