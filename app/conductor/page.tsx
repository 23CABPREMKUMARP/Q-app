...
export default function EnterpriseConductorPortal() {
  ...
  return (
    <SecureView>
      <div className="min-h-screen bg-[#ffffff] border border-[#E5E7EB] shadow-sm text-[#111827] text-zinc-900 font-sans antialiased overflow-x-hidden flex flex-col md:flex-row">
      ...
      <AnimatePresence>
        {!isAuthenticated && (
          <motion.div 
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="fixed inset-0 z-[1000] bg-[#ffffff] border border-[#E5E7EB] shadow-sm text-[#111827] flex flex-col items-center justify-center p-6 text-zinc-200 overflow-y-auto"
          >
            <div className="text-center space-y-4 max-w-md w-full p-8 border border-zinc-300 rounded-3xl bg-[#ffffff] border border-[#E5E7EB] shadow-sm text-[#111827] shadow-2xl relative">
              ...
              <div className="w-16 h-16 bg-gradient-to-br from-orange-500 to-orange-600 rounded-3xl flex items-center justify-center mx-auto shadow-lg shadow-orange-600/30">
                <ShieldCheck className="text-[#111827]" size={32} />
              </div>
              <h1 className="text-2xl font-black uppercase tracking-tight text-[#111827]">Transit Console</h1>
              ...
              {!isLoaded || isCheckingAssignment ? (
                ...
                <div className="space-y-4 pt-4">
                  ...
                  <div className="pt-4 space-y-3">
                    <button onClick={() => router.push("/")} className="w-full py-3 bg-[#ffffff] border border-[#E5E7EB] shadow-sm text-[#111827] hover:bg-zinc-700 text-[#111827] font-bold rounded-xl text-xs uppercase tracking-wider transition-all">
      ...
      {isAuthenticated && (
        <>
          {/* SIDEBAR FOR DESKTOP */}
          <aside className="hidden md:flex flex-col w-72 bg-[#ffffff] border border-[#E5E7EB] shadow-sm text-[#111827] border-r border-zinc-300 p-6 space-y-6 shrink-0">
            ...
            <div className="h-px bg-[#ffffff] border border-[#E5E7EB] shadow-sm text-[#111827]" />
              ...
              {[
                ...
                return (
                  <button
                    ...
                    className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl text-xs font-bold transition-all ${isActive ? "bg-orange-600 text-[#111827] shadow-md shadow-orange-600/10" : "text-zinc-600 hover:text-zinc-200 hover:bg-zinc-800/40"}`}
                  >
                    <Icon size={16} />
                    <span>{tab.label}</span>
                  </button>
            ...
            <div className="pt-4 border-t border-zinc-300 space-y-3">
              <div className="bg-[#ffffff] border border-[#E5E7EB] shadow-sm text-[#111827] p-3.5 rounded-xl border border-zinc-300 text-[10px] space-y-1">
              ...
              <button 
                ...
                className="w-full py-3 bg-[#ffffff] border border-[#E5E7EB] shadow-sm text-[#111827] hover:bg-zinc-755 border border-zinc-300 text-zinc-300 text-[10px] font-black uppercase tracking-wider rounded-xl transition-all active:scale-95"
              >
                Logout Shift
              </button>
            </div>
          ...
          {/* MOBILE HEADER */}
          <header className="md:hidden flex items-center justify-between px-5 py-4 bg-[#ffffff] border border-[#E5E7EB] shadow-sm text-[#111827] border-b border-zinc-300 sticky top-0 z-50 shadow-md">
            <div className="flex items-center gap-3">
              <button 
                onClick={() => setMobileMenuOpen(true)}
                className="p-1.5 bg-[#ffffff] border border-[#E5E7EB] shadow-sm text-[#111827] hover:bg-zinc-750 border border-zinc-300 rounded-lg text-zinc-300 mr-0.5"
              >
                <Menu size={16} />
              </button>
            ...
            <div className="flex items-center gap-2">
              ...
              <button 
                onClick={handleLogout}
                className="p-2 bg-[#ffffff] border border-[#E5E7EB] shadow-sm text-[#111827] border border-zinc-300 rounded-xl text-zinc-405 transition-colors"
              >
            ...
            {mobileMenuOpen && (
              <div className="fixed inset-0 z-[100] md:hidden">
                ...
                <motion.div 
                  ...
                  className="absolute left-0 top-0 bottom-0 w-64 bg-[#ffffff] border border-[#E5E7EB] shadow-sm text-[#111827] border-r border-zinc-300 p-6 flex flex-col justify-between"
                >
                  <div className="space-y-6">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        ...
                        <span className="font-black text-xs tracking-tight text-[#111827] uppercase">Transit Menu</span>
                      </div>
                        ...
                        return (
                          <button
                            ...
                            className={`w-full flex items-center gap-3 px-4 py-2.5 rounded-xl text-xs font-bold transition-all ${
                              isActive 
                                ? "bg-orange-600 text-[#111827] shadow-md" 
                  ...
                  <div className="pt-4 border-t border-zinc-300">
                    <button 
                      ...
                      className="w-full py-2.5 bg-[#ffffff] border border-[#E5E7EB] shadow-sm text-[#111827] hover:bg-zinc-700 text-zinc-350 text-[10px] font-black uppercase tracking-wider rounded-xl transition-all"
                    >
                      Logout Shift
                    </button>
                  </div>
          ...
          {/* MAIN CONTENT AREA */}
          <div className="flex-1 flex flex-col min-h-screen overflow-y-auto bg-[#ffffff] border border-[#E5E7EB] shadow-sm text-[#111827] pb-20 md:pb-6">
            
            {/* Top Stat Bar */}
            <div className="bg-[#ffffff] border border-[#E5E7EB] shadow-sm text-[#111827] border-b border-zinc-300 p-4 px-6 flex flex-wrap gap-4 items-center justify-between relative">
              <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-4 text-xs font-bold text-zinc-600">
                ...
                <span className="text-[10px] bg-[#ffffff] border border-[#E5E7EB] shadow-sm text-[#111827] border border-zinc-300 px-2 py-0.5 rounded text-orange-400 font-mono">
                  {tripStatus}
                </span>
              </div>
            </div>
            ...
            <div className="p-4 md:p-8 max-w-4xl w-full mx-auto space-y-6">
              ...
              {activeTab === "dashboard" && (
                <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-6">
                  ...
                  <div className="bg-[#ffffff] border border-[#E5E7EB] shadow-sm text-[#111827] border border-zinc-300 rounded-3xl p-6 relative overflow-hidden flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div className="space-y-2">
                      <div className="flex items-center gap-2">
                        <span className="text-xs font-black uppercase text-orange-500 tracking-widest">Conductor</span>
                        <span className="text-[9px] bg-[#ffffff] border border-[#E5E7EB] shadow-sm text-[#111827] text-zinc-600 px-2 py-0.5 rounded font-mono">Shift Active</span>
                      </div>
                      <h2 className="text-2xl font-black uppercase tracking-tight text-[#111827]">Rajesh Kumar</h2>
                    ...
                    <div className="flex flex-wrap gap-2 pt-2 md:pt-0">
                      <button 
                        ...
                        className="px-4 py-3 bg-[#ffffff] border border-[#E5E7EB] shadow-sm text-[#111827] hover:bg-zinc-700 border border-zinc-300 rounded-xl text-[10px] font-black uppercase tracking-widest flex items-center gap-2 transition-all active:scale-95"
                      >
                      ...
                      <button 
                        ...
                        className="px-4 py-3 bg-orange-600 hover:bg-orange-700 rounded-xl text-[10px] font-black uppercase tracking-widest flex items-center gap-2 transition-all active:scale-95 shadow-md shadow-orange-600/10 text-[#111827]"
                      >
                        <Bus size={12} />
                        Cycle Status
                      </button>
                  ...
                  <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                    {[
                      ...
                      return (
                        <div key={i} className="bg-[#ffffff] border border-[#E5E7EB] shadow-sm text-[#111827] border border-zinc-300 p-5 rounded-2xl space-y-2 shadow-md">
                          <div className="flex justify-between items-center text-zinc-500">
                            <span className="text-[9px] font-bold uppercase tracking-widest">{stat.title}</span>
                            <Icon size={14} className={stat.color} />
                          </div>
                          <h3 className="text-2xl font-black tracking-tight text-[#111827]">{stat.val}</h3>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {/* Shift Logs */}
                    <div className="bg-[#ffffff] border border-[#E5E7EB] shadow-sm text-[#111827] border border-zinc-300 rounded-3xl p-6 space-y-4">
              ...
              {activeTab === "scan" && (
                <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-6">
                  <div className="bg-[#ffffff] border border-[#E5E7EB] shadow-sm text-[#111827] border border-zinc-300 rounded-3xl p-6 text-center space-y-6 relative overflow-hidden">
                    ...
                    {!isScanning ? (
                      <div className="flex flex-col items-center justify-center py-6 gap-6">
                        ...
                        <div className="space-y-1">
                          <h2 className="text-xl font-black uppercase text-[#111827] tracking-tight">QR Scanner Engaged</h2>
                        ...
                        <button 
                          ...
                          className="w-full max-w-xs bg-orange-600 hover:bg-orange-700 text-[#111827] py-4 rounded-xl font-black uppercase tracking-widest text-xs flex items-center justify-center gap-3 active:scale-95 transition-all shadow-lg shadow-orange-600/10 cursor-pointer"
                        >
                          <Camera size={18} />
                      ...
                      <div className="space-y-4 max-w-sm mx-auto">
                        <div id="reader" className="overflow-hidden rounded-2xl border-4 border-orange-600 shadow-inner bg-[#ffffff] border border-[#E5E7EB] text-[#111827]" />
                        <button 
                          onClick={() => setIsScanning(false)}
                          className="w-full bg-[#ffffff] border border-[#E5E7EB] shadow-sm text-[#111827] hover:bg-zinc-800 border border-zinc-300 text-zinc-600 py-3 rounded-xl font-bold uppercase tracking-widest text-[9px]"
                        >
                          Cancel Scanner
                        </button>
                      </div>
                  ...
                  <AnimatePresence mode="wait">
                    {validating && (
                      <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="bg-[#ffffff] border border-[#E5E7EB] shadow-sm text-[#111827] border border-zinc-300 rounded-3xl p-8 text-center space-y-4">
                      ...
                      >
                        <div className="flex flex-col items-center gap-6">
                          ...
                          {scanResult.booking?.passengers && scanResult.booking.passengers.length > 0 && (scanResult.booking.boarding_point === "Combined Journey" || scanResult.booking.boardingPoint === "Combined Journey") ? (
                            <div className="w-full bg-[#ffffff] border border-[#E5E7EB] shadow-sm text-[#111827] border border-zinc-300 rounded-xl p-4 mt-2">
                              ...
                              <div className="space-y-3">
                                {scanResult.booking.passengers.map((p: any, idx: number) => (
                                  <div key={idx} className="text-xs bg-[#ffffff] border border-[#E5E7EB] shadow-sm text-[#111827] border border-zinc-300 rounded-lg p-3">
                  ...
                  <div className="bg-[#ffffff] border border-[#E5E7EB] shadow-sm text-[#111827] border border-zinc-300 rounded-3xl p-6 space-y-4">
                    ...
                    <div className="flex gap-2">
                      <input 
                        ...
                        className="flex-1 bg-[#ffffff] border border-[#E5E7EB] shadow-sm text-[#111827] border border-zinc-300 rounded-xl py-3 px-4 focus:outline-none focus:ring-1 focus:ring-orange-500 text-sm text-zinc-900 placeholder:text-zinc-750 font-mono"
                      />
                      <button
                        onClick={() => {
                        ...
                        className="px-5 bg-orange-600 hover:bg-orange-700 text-[#111827] rounded-xl text-[10px] font-black uppercase tracking-wider shadow-md shadow-orange-600/10"
                      >
                        Verify
                      </button>
                    </div>
              ...
              {activeTab === "ticketing" && (
                <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {/* form card */}
                    <div className="bg-[#ffffff] border border-[#E5E7EB] shadow-sm text-[#111827] border border-zinc-300 rounded-3xl p-6 space-y-5 text-left">
                      ...
                      <form onSubmit={handleIssueTicket} className="space-y-4">
                        ...
                        <div className="space-y-1">
                          ...
                          <select 
                            ...
                            className="w-full bg-zinc-955 border border-zinc-300 rounded-xl py-3 px-4 focus:outline-none focus:ring-1 focus:ring-orange-500 text-sm text-zinc-900"
                          >
                            {STOPS.map((s) => (
                        ...
                        <div className="space-y-1">
                          ...
                          <div className="flex items-center gap-3 bg-zinc-955 border border-zinc-300 rounded-xl p-1.5 max-w-[150px] justify-between">
                            <button
                              ...
                              className="w-9 h-9 bg-[#ffffff] border border-[#E5E7EB] shadow-sm text-[#111827] border border-zinc-300 text-zinc-300 rounded-lg flex items-center justify-center hover:bg-zinc-800 cursor-pointer"
                            >
                              <Minus size={14} />
                            </button>
                            <span className="text-sm font-black text-[#111827]">{obQuantity}</span>
                            <button
                              type="button"
                              onClick={() => {
                        ...
                        <div className="pt-2">
                          <div className="flex justify-between items-center bg-zinc-955 p-4 rounded-xl border border-zinc-300 mb-4">
                            ...
                            <span className="text-xl font-black text-[#111827]">₹{ticketFare}</span>
                          </div>

                          <button
                            type="submit"
                            disabled={obBoarding === obDestination}
                            className="w-full py-4 bg-orange-600 hover:bg-orange-700 text-[#111827] rounded-xl font-black uppercase tracking-widest text-xs shadow-lg shadow-orange-600/15 disabled:opacity-40 cursor-pointer"
                          >
                            Print & Issue Ticket
                          </button>
                        </div>
                    ...
                    <div className="flex flex-col items-center justify-center">
                      <AnimatePresence mode="wait">
                        {obSuccessTicket ? (
                          ...
                          <div className="text-center p-8 bg-zinc-900/40 border-2 border-dashed border-zinc-300 rounded-3xl w-full py-16 space-y-3">
              ...
              {activeTab === "passengers" && (
                <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-6 text-left">
                  ...
                  {/* Search and Filters */}
                  <div className="bg-[#ffffff] border border-[#E5E7EB] shadow-sm text-[#111827] border border-zinc-300 rounded-3xl p-5 space-y-4">
                    <div className="flex gap-2">
                  ...
                  <div className="bg-[#ffffff] border border-[#E5E7EB] shadow-sm text-[#111827] border border-zinc-300 rounded-3xl overflow-hidden shadow-md">
                    <div className="overflow-x-auto">
                      <table className="w-full text-left text-xs">
                        <thead className="bg-[#ffffff] border border-[#E5E7EB] shadow-sm text-[#111827] border-b border-zinc-300 text-[9px] font-black uppercase text-zinc-500 tracking-wider">
                          <tr>
                  ...
                  <div className="bg-[#ffffff] border border-[#E5E7EB] shadow-sm text-[#111827] border border-zinc-300 rounded-3xl p-6 space-y-4">
                    <div className="flex justify-between items-center border-b border-zinc-300 pb-3">
                      ...
                      <div className="text-right">
                        <span className="text-2xl font-black text-[#111827]">{occupancy}/50</span>
                    ...
                    <div className="flex gap-4 text-[9px] font-black uppercase tracking-wider text-zinc-500">
                      ...
                      <div className="flex items-center gap-1.5">
                        <div className="w-3.5 h-3.5 bg-[#ffffff] border border-[#E5E7EB] shadow-sm text-[#111827] border border-zinc-300 rounded" />
                    ...
                    <div className="bg-zinc-955 border border-zinc-850 p-6 rounded-2xl relative overflow-hidden">
                      ...
                      <div className="flex justify-between items-center border-b border-zinc-300 pb-4 mb-6">
                        <div className="w-8 h-8 rounded-full border-4 border-dashed border-zinc-300 flex items-center justify-center">
                          <div className="w-3 h-3 bg-[#ffffff] border border-[#E5E7EB] shadow-sm text-[#111827] rounded-full" />
                        </div>
                            ...
                            return (
                              <React.Fragment key={`aisle-${idx}`}>
                                ...
                                <button
                                  ...
                                  className={`h-9 rounded-xl border text-[9px] font-bold flex items-center justify-center transition-all active:scale-90 cursor-pointer ${isOccupied ? "bg-orange-600 border-orange-500 text-[#111827] shadow-md shadow-orange-600/10" : "bg-zinc-955 border-zinc-300 text-zinc-700 hover:border-zinc-700"}`}
                                >
                                  S{seatNum}
                                </button>
                              </React.Fragment>
              ...
              {activeTab === "gps" && (
                <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-5 text-left">
                  ...
                  <div className="bg-[#ffffff] border border-[#E5E7EB] shadow-sm text-[#111827] border border-zinc-300 rounded-3xl p-6">
                    <div className="flex items-center justify-between mb-5">
                      <div className="flex items-center gap-3">
                        <div className={`w-12 h-12 rounded-2xl flex items-center justify-center transition-all ${
                          gpsState.status === 'broadcasting'
                            ? 'bg-[#FF5F1F] text-[#111827] shadow-lg shadow-[#FF5F1F]/30'
                            : gpsState.status === 'no_permission'
                            ? 'bg-[#EF4444]/10 border border-[#EF4444]/20 text-[#EF4444]'
                            : 'bg-[#ffffff] border border-[#E5E7EB] shadow-sm text-[#111827] text-zinc-500 border border-zinc-300'
                        }`}>
                          {gpsState.status === 'broadcasting'
                      ...
                      <button
                        ...
                        className={`px-5 py-3 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all active:scale-95 disabled:opacity-40 ${
                          gpsEnabled
                            ...
                            : 'bg-[#FF5F1F] hover:bg-[#FF5F1F] text-[#111827] shadow-lg shadow-[#FF5F1F]/30'
                        }`}
                      >
                    ...
                    <div className="grid grid-cols-2 gap-3 font-mono">
                      <div className="bg-[#ffffff] border border-[#E5E7EB] shadow-sm text-[#111827] rounded-xl p-3 border border-zinc-300">
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    <div className="bg-[#ffffff] border border-[#E5E7EB] shadow-sm text-[#111827] border border-zinc-300 rounded-2xl p-4 text-center">
                      <Gauge size={18} className="text-[#FF5F1F] mx-auto mb-2" />
                    ...
                    <div className="bg-[#ffffff] border border-[#E5E7EB] shadow-sm text-[#111827] border border-zinc-300 rounded-2xl p-4 text-center">
                      <Radio size={18} className="text-[#FF5F1F] mx-auto mb-2" />
                  ...
                  {/* Current Route */}
                  <div className="bg-[#ffffff] border border-[#E5E7EB] shadow-sm text-[#111827] border border-zinc-300 rounded-2xl p-4 flex items-center gap-3">
                    <Bus size={20} className="text-[#FF5F1F] flex-shrink-0" />
                    ...
                    <div className={`text-[9px] font-black px-2.5 py-1 rounded-full uppercase tracking-widest ${
                      tripStatus === 'Trip Started' || tripStatus === 'Boarding'
                        ...
                        : 'bg-[#ffffff] border border-[#E5E7EB] shadow-sm text-[#111827] text-zinc-600'
                    }`}>{tripStatus}</div>
                  </div>

                  {/* Trip Status Controls */}
                  <div className="bg-[#ffffff] border border-[#E5E7EB] shadow-sm text-[#111827] border border-zinc-300 rounded-2xl p-5 space-y-3">
                        ...
                        return (
                          <button
                            ...
                            className={`flex flex-col items-center justify-center p-3 rounded-xl border transition-all text-center gap-1.5 cursor-pointer ${
                              isActive ? 'bg-orange-600 border-orange-500 text-[#111827] shadow-md' : 'bg-[#ffffff] border border-[#E5E7EB] shadow-sm text-[#111827] border-zinc-300 text-zinc-500 hover:border-zinc-700 hover:text-zinc-300'
                            }`}
                          >
                            <Icon size={16} />
                ...
                <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-6 text-left">
                  ...
                  <div className="bg-[#ffffff] border border-[#E5E7EB] shadow-sm text-[#111827] border border-zinc-300 rounded-3xl p-6 space-y-4">
                    ...
                    <button
                      ...
                      className="w-full py-4 bg-orange-600 hover:bg-orange-700 text-[#111827] rounded-xl font-black uppercase tracking-widest text-[9px] active:scale-95 shadow-md shadow-orange-600/10 cursor-pointer"
                    >
                ...
                <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-6 text-left">
                  ...
                  <div className="bg-[#ffffff] border border-[#E5E7EB] shadow-sm text-[#111827] border border-zinc-300 rounded-3xl p-6 space-y-4">
                    <div className="flex justify-between items-center border-b border-zinc-300 pb-3">
                      ...
                      <span className="text-[10px] bg-[#ffffff] border border-[#E5E7EB] shadow-sm text-[#111827] border border-zinc-300 px-2 py-0.5 rounded font-mono text-zinc-600">
                    ...
                    {offlineQueue.length > 0 ? (
                      <div className="space-y-3">
                        ...
                        <button
                          ...
                          className="w-full py-4 mt-4 bg-orange-600 hover:bg-orange-700 text-[#111827] rounded-xl font-black uppercase tracking-widest text-[9px] active:scale-95 shadow-md shadow-orange-600/10 disabled:opacity-40 cursor-pointer"
                        >
                ...
                <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-6 text-left">
                  <div className="bg-[#ffffff] border border-[#E5E7EB] shadow-sm text-[#111827] border border-zinc-300 rounded-3xl p-6 space-y-4">
                    ...
                    <form onSubmit={handleReportIssue} className="space-y-4">
                      ...
                      <button
                        type="submit"
                        className="w-full py-4 bg-orange-600 hover:bg-orange-700 text-[#111827] rounded-xl font-black uppercase tracking-widest text-[9px] shadow-lg shadow-orange-600/15 cursor-pointer"
                      >
          ...
          <nav className="md:hidden fixed bottom-0 left-0 right-0 bg-[#ffffff] border border-[#E5E7EB] shadow-sm text-[#111827] border-t border-zinc-300 px-6 py-3.5 flex items-center justify-between z-50 safe-bottom shadow-lg">
             {[
            ...
            {showQR && (
              ...
              >
                 <button 
                   ...
                   className="absolute top-8 right-8 w-12 h-12 bg-[#ffffff] border border-[#E5E7EB] shadow-sm text-[#111827] hover:bg-zinc-700 rounded-full flex items-center justify-center text-[#111827] border border-zinc-750"
                 >
                   <X size={20} />
                 </button>
