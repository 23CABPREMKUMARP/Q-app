...
function EnterpriseAdminDashboardContent() {
  ...
  if (!isLoaded) {
    return (
      <div className="min-h-screen bg-[#FFFFFF] border border-[#E5E7EB] shadow-sm text-[#1A0B00] flex items-center justify-center text-zinc-600 font-sans">
  ...
  if (!isSignedIn) {
    return (
      <div className="min-h-screen bg-[#FFFFFF] border border-[#E5E7EB] shadow-sm text-[#1A0B00] flex items-center justify-center p-6 font-sans">
        <div className="max-w-md w-full bg-[#FFFFFF] border border-[#E5E7EB] shadow-sm text-[#1A0B00] border border-zinc-300 rounded-3xl p-8 shadow-2xl text-center space-y-6">
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 lg:grid-cols-5 gap-4">
                {[
                  ...
                  return (
                    <div key={i} className="bg-[#FFFFFF] border border-[#E5E7EB] shadow-sm text-[#1A0B00] border border-zinc-800/80 rounded-xl p-4 flex flex-col justify-between h-28 relative overflow-hidden group">
            ...
            <div className="space-y-6">
              <div className="flex justify-between items-end">
                ...
                <button 
                  ...
                  className="bg-[#FFFFFF] text-[#1A0B00] hover:bg-zinc-200 font-medium text-[12px] px-4 py-2 rounded-md shadow-sm flex items-center gap-2 transition-all"
                >
              ...
              {/* Table */}
              <div className="bg-[#FFFFFF] border border-[#E5E7EB] shadow-sm text-[#1A0B00] border border-zinc-800/80 rounded-xl overflow-hidden">
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            <button
                              ...
                              className={`text-[10px] font-medium px-2 py-0.5 rounded transition-colors ${
                                gpsOn ? 'bg-zinc-200 text-[#1A0B00] hover:bg-[#FFFFFF]' : 'bg-[#FFFFFF] border border-[#E5E7EB] shadow-sm text-[#1A0B00] text-zinc-600 hover:bg-zinc-700'
                              }`}
                            >
                      ...
                      <tr key={b.id || idx} className="hover:bg-zinc-800/20 transition-colors">
                        ...
                        <td className="py-3 px-5 text-right">
                          <button 
                            ...
                            className="px-2 py-1 rounded bg-[#FFFFFF] border border-[#E5E7EB] shadow-sm text-[#1A0B00] text-zinc-600 hover:text-[#EF4444] hover:bg-[#EF4444]/10 transition-colors text-[11px] font-medium"
                          >
                            Refund
                          </button>
                        </td>
...
export default function EnterpriseAdminDashboard() {
  return (
    <SecureView>
      <Suspense fallback={
        <div className="flex min-h-screen flex-col items-center justify-center bg-[#FFFFFF] border border-[#E5E7EB] text-[#1A0B00] text-[#1A0B00] p-4">
